...
print_usage_and_exit(const char* const program_name, const int exit_status) {
  std::cerr
      << "\n\nUsage : " << program_name
      << " [-h|--help] listmode_binary_file tstart tstop [-N|--norm_binary <filename>] [-p|--prompts <filename>] [-d|--delayeds "
         "<filename>] [-r|--randoms <filename>] [-n|--norm_sino <filename>] [--cuda_device <val>] [-v|--verbose <val>]\n\n";
  exit(exit_status);
}
