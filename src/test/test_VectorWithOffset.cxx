...
// check reserve -1,2 and then 1,6
{
  ...
  // note: for length 0 vectors, get_capacity_min_index() is always 0
  check_if_equal(test.get_capacity_min_index(), 0, "check reserve of empty vector (-1,2 and then 1,6) (capacity_min_index)");
  check_if_equal(test.get_capacity_max_index(), 5, "check reserve of empty vector (-1,2 and then 1,6) (capacity_max_index)");
}
...
// tests of resize() with non-zero length
{
  ...
  check_if_equal(test.get_capacity_min_index(), ref.get_min_index(), "check resize with identical range (capacity_min_index)");
  check_if_equal(test.get_capacity_max_index(), ref.get_max_index(), "check resize with identical range (capacity_max_index)");
  ...
  check_if_equal(test.get_capacity_min_index(), ref.get_min_index(), "check resize with grow on high index (capacity_min_index)");
  check_if_equal(test.get_capacity_max_index(), ref.get_max_index() + 5,
  ...
  check_if_equal(test.get_capacity_max_index(), ref.get_max_index(), "check resize with grow on low index (capacity_max_index)");
  ...
  check_if_equal(test.get_capacity_min_index(), ref.get_min_index(), "check resize with shrink at both ends(capacity_min_index)");
  check_if_equal(test.get_capacity_max_index(), ref.get_max_index(), "check resize with shrink at both ends(capacity_max_index)");
...
// checks on using existing data_ptr with constructor indices starting at -3
{
  ...
  check_if_equal(data_ptr[4 - v.get_min_index()], 4,
