...
private:
  ...
  */
  void run_tests_one_shape(Shape3D& shape, VoxelsOnCartesianGrid<float>& image, const bool do_rotated_ROI_test = true);
};

void
ROITests::run_tests_one_shape(Shape3D& shape, VoxelsOnCartesianGrid<float>& image, const bool do_rotated_ROI_test) {
