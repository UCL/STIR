...
void
integrate_discrete_functionTests::run_tests() {
  ...
  // quadratic
  {
    ...
    check_if_equal(stir_result, analytic_result,
                   "check integrate_discrete_function implementation for quadratic function using trapezoidal approximation");
