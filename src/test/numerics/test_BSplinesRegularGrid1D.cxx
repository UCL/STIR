...
private:
  ...
  bool check_at_sample_points(const Array<1, elemT>& v, BSplinesRegularGrid<1, elemT, elemT>& interpolator,
  ...
  template <class elemT>
  bool check_coefficients(const Array<1, elemT>& v, BSplinesRegularGrid<1, elemT, elemT>& interpolator,
                          const char* const message) {
    IndexRange<1> out_range(static_cast<int>(v.size()));
    Array<1, elemT> out(out_range);
