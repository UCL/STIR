...
BSplinesRegularGrid_Tests::run_tests()
{
  ...
  }
  {
    cerr << "\nTesting BSplinesRegularGrid: Nearest Neighbour values and constructor using a 2D array as input..." << endl;
    {
      ...
      check_at_sample_points(linear_const_input_sample,
                             BSplinesRegularGridTest_linear_const,
      ...
      check_near_sample_points(
          random_input_sample,
          BSplinesRegularGridTest_random,
          epsilon_1,
  ...
  }
  {
    cerr << "\nTesting BSplinesRegularGrid: linear interpolation values and constructor using a 2D array as input..." << endl;
    {
      ...
      //                                      check_at_half_way(random_input_sample, BSplinesRegularGridTest_random);
      check_near_sample_points(random_input_sample,
                               BSplinesRegularGridTest_random,
                               epsilon_1,
  ...
  }
  {
    cerr << "\nTesting BSplinesRegularGrid: quadratic interpolation values and constructor using a 2D array as input..." << endl;
    {
      ...
      //                                      check_at_half_way(random_input_sample, BSplinesRegularGridTest_random);
      check_at_sample_points(
          gaussian_input_sample, BSplinesRegularGridTest_gaussian, "check BSplines implementation for quadratic interpolation");

      check_near_sample_points(gaussian_input_sample,
      ...
      check_near_sample_points(gaussian_input_sample,
                               ...
                               epsilon_4,
                               "Check BSplines implementation for quadratic interpolation near samples");
      check_at_half_way(gaussian_input_sample,
                        gaussian_check_sample,
                        BSplinesRegularGridTest_gaussian,
  ...
  }
  {
    cerr << "\nTesting BSplinesRegularGrid: Cubic interpolation values and constructor using a 2D array as input..." << endl;
    {
      ...
      check_at_sample_points(
          gaussian_input_sample, BSplinesRegularGridTest_gaussian, "check BSplines implementation for cubic interpolation");
      ...
      //////// gradient
      {
        ...
        check_gradient(
            BSplinesRegularGridTest_gaussian, Coordinate2D<pos_type>(1.1, 2.2), "cubic-spline gradient: Gaussian test-case 1");
        check_gradient(
            BSplinesRegularGridTest_gaussian, Coordinate2D<pos_type>(3.1, 4.2), "cubic-spline gradient: Gaussian test-case 2");
        check_gradient(BSplinesRegularGridTest_linear_const,
                       Coordinate2D<pos_type>(3.1, 4.2),
  ...
  }
  {
    cerr << "\nTesting BSplinesRegularGrid: oMoms interpolation values and constructor using a 2D array as input..." << endl;
    {
      ...
      check_at_sample_points(
          gaussian_input_sample, BSplinesRegularGridTest_gaussian, "check BSplines implementation for oMoms interpolation");
      check_near_sample_points(gaussian_input_sample,
                               BSplinesRegularGridTest_gaussian,
                               epsilon_1,
  ...
  }
  {
         ...
         << endl;
    {
      ...
      check_coefficients(
          const_input_sample, BSplinesRegularGridTest_const, "check BSplines implementation for linear_cubic interpolation");
      check_at_sample_points(
          const_input_sample, BSplinesRegularGridTest_const, "check BSplines implementation for linear_cubic interpolation");
      //                                      check_at_half_way(const_input_sample, BSplinesRegularGridTest_const);
      check_at_sample_points(linear_const_input_sample,
      ...
      //                                      check_at_half_way(linear_const_input_sample, BSplinesRegularGridTest_linear_const);
      check_at_sample_points(
          random_input_sample, BSplinesRegularGridTest_random, "check BSplines implementation for linear_cubic interpolation");
      //                                      check_at_half_way(random_input_sample, BSplinesRegularGridTest_random);

      check_at_sample_points(gaussian_input_sample,
                             BSplinesRegularGridTest_gaussian,
                             "check BSplines implementation for linear_cubic interpolation");
      check_near_sample_points(gaussian_input_sample,
                               BSplinesRegularGridTest_gaussian,
