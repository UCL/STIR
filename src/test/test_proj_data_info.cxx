...
{ 
  ...
  }
  {
    ...
    
    {
      ...
      check_if_equal( phi, 10*ob2.get_azimuthal_angle_sampling()+ scanner_ptr->get_intrinsic_azimuthal_tilt(), " get_phi , seg 0");
    ...
    }
    {
      ...
      check_if_equal( phi, 10*ob2.get_azimuthal_angle_sampling()+ scanner_ptr->get_intrinsic_azimuthal_tilt(), " get_phi , seg 1");
      // KT 25/10/2000 adjust to new convention
      const float ax_pos_origin =
