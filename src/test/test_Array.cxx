...
private:
  ...
  void run_IO_tests_mixed(OFSTREAM& os, IFSTREAM& is, const Array<num_dimensions, elemT>& orig,
  ...
  bool check_array_equality_with_rounding(const Array<num_dimensions, elemT>& orig,
                                          const Array<num_dimensions, output_type>& data_read_back, const char* const message) {
    NumericInfo<output_type> output_type_info;
