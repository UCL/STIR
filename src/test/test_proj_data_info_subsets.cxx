  ...
  try
    {
      // check get_original_view_nums() on the original data
      {
        ...
        check_if_equal(views[0], input_sino_sptr->get_min_view_num(), "check get_original_view_nums on non-subset data: first view");
        check_if_equal(views[views.size()-1], input_sino_sptr->get_max_view_num(), "check get_original_view_nums on non-subset data: last view");
      }
