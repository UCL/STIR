...
void OSSPSReconstruction::update_image_estimate(DiscretisedDensity<3,float> &current_image_estimate)
{
 ...
 // truncate_rim(*numerator_ptr,rim_truncation_image);
  ...
  ((ParabolicSurrogatePrior<float>*)parameters.prior_ptr.get())->parabolic_surrogate_curvature(*work_image_ptr, current_image_estimate); 
  
  *work_image_ptr *= 2*parameters.num_subsets; 
