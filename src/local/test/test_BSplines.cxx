...
{  
  cerr << "Testing BSplines function..." << endl;
  set_tolerance(0.00001); 
  typedef double elemT;
  BSplines1DRegularGrid<double, double> BSplines1DRegularGridTests;

  {
	  cerr << "Testing BSplines_weight function..." << endl;
	  std::vector<elemT> BSplines_weight_STIR_vector, BSplines_weight_correct_vector;
	  BSplines_weight_STIR_vector.push_back(BSplines1DRegularGridTests.BSplines_weight(0.));
  
	  for(elemT i=0.3; i<=3 ;++i)
		  BSplines_weight_STIR_vector.push_back(BSplines1DRegularGridTests.BSplines_weight(i));
  ...
  {  
	  ...
	  BSplines_1st_der_weight_STIR_vector.push_back(BSplines1DRegularGridTests.BSplines_1st_der_weight(0.));

	  for(elemT i=0.3; i<=3 ;++i)
		  BSplines_1st_der_weight_STIR_vector.push_back(BSplines1DRegularGridTests.BSplines_1st_der_weight(i));
