...
CListModeDataBasedOnCoordinateMap<CListRecordT>::CListModeDataBasedOnCoordinateMap(const std::string& listmode_filename,
...
template <class CListRecordT>
CListModeDataBasedOnCoordinateMap<CListRecordT>::CListModeDataBasedOnCoordinateMap(
    const std::string& listmode_filename, const shared_ptr<const ProjDataInfo>& proj_data_info_sptr)
    : listmode_filename(listmode_filename)
{
  shared_ptr<ExamInfo> _exam_info_sptr(new ExamInfo);
  _exam_info_sptr->imaging_modality = ImagingModality::PT;
...
template <class CListRecordT>
std::string
CListModeDataBasedOnCoordinateMap<CListRecordT>::get_name() const
{
...
CListModeDataBasedOnCoordinateMap<CListRecordT>::get_empty_record_sptr() const
{
...
template <class CListRecordT>
Succeeded
CListModeDataBasedOnCoordinateMap<CListRecordT>::get_next_record(CListRecord& record_of_general_type) const
{
...
template <class CListRecordT>
Succeeded
CListModeDataBasedOnCoordinateMap<CListRecordT>::reset()
{
