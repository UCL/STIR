...
CListEventPENN::CListEventPENN(const shared_ptr<Scanner>& scanner_sptr)
...
void
CListEventPENN::get_detection_position(DetectionPositionPair<>& det_pos) const
{
...
void
CListEventPENN::set_detection_position(const DetectionPositionPair<>&)
{
  error("CListEventPENN: cannot set events yet through this function.");
}

void
CListEventPENN::init_from_data(bool d, int dt, int xa, int xb, int za, int zb, int ea, int eb)
{
  delay = d;
