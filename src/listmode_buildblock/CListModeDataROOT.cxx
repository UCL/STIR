...
CListModeDataROOT::CListModeDataROOT(const std::string& hroot_filename) : hroot_filename(hroot_filename) {
  set_defaults();
  ...
  // will be the selected.
    ...
    this_scanner_sptr.reset(new Scanner(Scanner::User_defined_scanner, std::string("ROOT_defined_scanner"),
                                        /* num dets per ring */
                                        ...
                                        /* ring spacing */
                                        this->ring_spacing * 10.f, this->bin_size * 10.f,
                                        /* offset*/
