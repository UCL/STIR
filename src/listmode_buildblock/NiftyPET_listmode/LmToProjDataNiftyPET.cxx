...
void
LmToProjDataNiftyPET::check_input() const {
...
void
LmToProjDataNiftyPET::process_data() {
  ...
  helper.lm_to_proj_data(_prompts_sptr, _delayeds_sptr, _randoms_sptr, _norm_sptr, _start_time, _stop_time, _listmode_binary_file,
                         _norm_binary_file);
}
