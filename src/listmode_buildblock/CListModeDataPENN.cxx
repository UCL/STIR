...
CListModeDataPENN::
CListModeDataPENN(const std::string& listmode_filename)
...
Succeeded
CListModeDataPENN::
set_get_position(const CListModeDataPENN::SavedPosition& pos)
{
    return
            lm_data_sptr->set_get_position(pos);
}
...
{
    lm_data_sptr->set_new_record(is_delay, _dt,
                                _xa, _xb,
                                _za, _zb,
                                _ea, _eb);
}
