...
CListEventROOT::CListEventROOT(const shared_ptr<const ProjDataInfo>& proj_data_info)
...
void
CListEventROOT::init_from_data(const int& _ring1, const int& _ring2, const int& crystal1, const int& crystal2,
