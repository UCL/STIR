...
class ModifiedInverseAverigingImageFilter
    : public RegisteredParsingObject<ModifiedInverseAverigingImageFilter<elemT>,
                                     ...
                                     DataProcessor<DiscretisedDensity<num_dimensions, elemT>>> {
private:
  typedef RegisteredParsingObject<ModifiedInverseAverigingImageFilter<elemT>,
                                  DataProcessor<DiscretisedDensity<num_dimensions, elemT>>,
                                  DataProcessor<DiscretisedDensity<num_dimensions, elemT>>>
      base_type;
...
public:
  ...
  ModifiedInverseAverigingImageFilter(string proj_data_filename, string attenuation_proj_data_filename,
                                      ...
                                      DiscretisedDensity<3, float>* sensitivity_image, int mask_size, bool z_direction_trivial);
