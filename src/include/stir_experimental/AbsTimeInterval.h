...
public:
  ...
  AbsTimeInterval() : _start_time_in_secs_since_1970(0), _end_time_in_secs_since_1970(0) {}
  AbsTimeInterval(double start_time_in_secs_since_1970, double end_time_in_secs_since_1970)
      : _start_time_in_secs_since_1970(start_time_in_secs_since_1970), _end_time_in_secs_since_1970(end_time_in_secs_since_1970) {
  }
