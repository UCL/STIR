...
void fwd_project(ProjData& proj_data,
...
void do_segments_densels_fwd(const VoxelsOnCartesianGrid<float>& image,
                             ProjData& proj_data,
...
void fwd_densels_all(VectorWithOffset<SegmentByView<float>*>& all_segments,
...
void find_inverse_and_bck_densels(DiscretisedDensity<3, float>& image,
                                  VectorWithOffset<SegmentByView<float>*>& all_segments,
