...
class PostsmoothingForwardProjectorByBin
    : public RegisteredParsingObject<PostsmoothingForwardProjectorByBin, ForwardProjectorByBin> {
public:
  ...
  PostsmoothingForwardProjectorByBin(const shared_ptr<ForwardProjectorByBin>& original_forward_projector_ptr,
                                     const VectorWithOffset<float>& tangential_kernel,
                                     const VectorWithOffset<float>& axial_kernel, const bool smooth_segment_0_axially = false);
...
private:
  ...
  void smooth(Viewgram<float>&, const int min_axial_pos_num, const int max_axial_pos_num, const int min_tangential_pos_num,
