...
public:
  ...
  */
  ...
  inline void get_proj_matrix_elems_for_one_densel(ProjMatrixElemsForOneDensel&, const Densel&) STIR_MUTABLE_CONST;
...
protected:
  ...
  */
  ...
  inline void cache_proj_matrix_elems_for_one_densel(const ProjMatrixElemsForOneDensel&) STIR_MUTABLE_CONST;
