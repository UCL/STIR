...
LineSource_phantom::LineSource_phantom() {
  A_ptr = new EllipsoidalCylinder(150, 0, 0, CartesianCoordinate3D<float>(0, 0, 0), 0, 0, 0);
}
...
CylindersWithLineSource_phantom::CylindersWithLineSource_phantom() {
  ...
  B_ptr = new EllipsoidalCylinder(1, 8, 8, CartesianCoordinate3D<float>(0, -14, 5), 0, 0, 0);

  C_ptr = new EllipsoidalCylinder(1, 8, 8, CartesianCoordinate3D<float>(0, 14, 5), 0, 0, 0);
...
CylindersWithLineSource_phantom::make_union_ptr(const float fraction) const {
  ...
  shared_ptr<Shape3D> AB_union = new CombinedShape3D<logical_and<bool>>(full_C, full_B);
