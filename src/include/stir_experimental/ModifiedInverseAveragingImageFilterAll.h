...
class ModifiedInverseAveragingImageFilterAll
    : public RegisteredParsingObject<ModifiedInverseAveragingImageFilterAll<elemT>,
                                     ...
                                     DataProcessor<DiscretisedDensity<num_dimensions, elemT>>> {
private:
  typedef RegisteredParsingObject<ModifiedInverseAveragingImageFilterAll<elemT>,
                                  DataProcessor<DiscretisedDensity<num_dimensions, elemT>>,
                                  DataProcessor<DiscretisedDensity<num_dimensions, elemT>>>
      base_type;
...
public:
  ...
  ModifiedInverseAveragingImageFilterAll(string proj_data_filename, string attenuation_proj_data_filename,
                                         const VectorWithOffset<elemT>& filter_coefficients, shared_ptr<ProjData> proj_data_ptr,
...
private:
  ...
  void precalculate_filter_coefficients(
  ...
  void precalculate_filter_coefficients_separable(
  ...
  mutable ModifiedInverseAverigingArrayFilter<num_dimensions, elemT> inverse_filter;
};
