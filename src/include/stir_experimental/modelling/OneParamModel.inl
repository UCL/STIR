...
//! default constructor
OneParamModel::OneParamModel() { _matrix_is_stored = false; }
...
ModelMatrix<1>
OneParamModel::get_unit_matrix(const int starting_frame, const int last_frame) {
