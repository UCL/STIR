...
Array<1, elemT>::Array(const IndexRange<1>& range) : base_type() { grow(range); }

Array<1, elemT>::Array(const int min_index, const int max_index) : base_type() { grow(min_index, max_index); }
