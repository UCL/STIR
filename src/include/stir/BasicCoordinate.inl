...
template <int num_dimensions, class coordT>
inline bool
coordinate_less_than_help(is_not_1d, const BasicCoordinate<num_dimensions, coordT>& c1,
...
template <class coordT>
inline bool
coordinate_less_than_help(is_not_1d, const BasicCoordinate<4, coordT>& c1, const BasicCoordinate<4, coordT>& c2) {
  return c1[1] < c2[1] ||
         (c1[1] == c2[1] && (c1[2] < c2[2] || c1[2] == c2[2] && (c1[3] < c2[3] || c1[3] == c2[3] && c1[4] < c2[4])));
}
#endif
...
template <class coordT>
bool inline
operator<(const BasicCoordinate<1, coordT>& c1, const BasicCoordinate<1, coordT>& c) {
  return detail::coordinate_less_than_help(detail::is_1d(), c1, c);
}
#  define DEFINE_OPERATOR_LESS(num_dimensions)                                                                                   \
    template <class coordT>                                                                                                      \
    inline bool operator<(const BasicCoordinate<num_dimensions, coordT>& c1, const BasicCoordinate<num_dimensions, coordT>& c) { \
      return detail::coordinate_less_than_help(detail::is_not_1d(), c1, c);                                                      \
    }
