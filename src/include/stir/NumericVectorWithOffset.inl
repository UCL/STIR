...
inline NumericVectorWithOffset<T, NUMBER>::NumericVectorWithOffset() : base_type() {}

template <class T, class NUMBER>
inline NumericVectorWithOffset<T, NUMBER>::NumericVectorWithOffset(const int hsz) : base_type(hsz) {}
...
template <class T, class NUMBER>
NumericVectorWithOffset<T, NUMBER>::NumericVectorWithOffset(const VectorWithOffset<T>& t) : base_type(t) {}
...
inline void
NumericVectorWithOffset<T, NUMBER>::axpby(const NUMBER2 a, const NumericVectorWithOffset& x, const NUMBER2 b,
...
template <class T, class NUMBER>
inline void
NumericVectorWithOffset<T, NUMBER>::xapyb(const NumericVectorWithOffset& x, const NUMBER a, const NumericVectorWithOffset& y,
                                          const NUMBER b) {
  this->check_state();
...
template <class T, class NUMBER>
inline void
NumericVectorWithOffset<T, NUMBER>::xapyb(const NumericVectorWithOffset& x, const NumericVectorWithOffset& a,
