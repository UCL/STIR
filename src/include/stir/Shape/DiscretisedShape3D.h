...
public:
  ...
  */
  ...
  virtual bool operator==(const Shape3D&) const {
  ...
  */
  virtual float get_voxel_weight(const CartesianCoordinate3D<float>& coord, const CartesianCoordinate3D<float>& voxel_size,
