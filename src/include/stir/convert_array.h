...
inline void find_scale_factor(scaleT& scale_factor, const Array<num_dimensions, T1>& data_in,
...
*/
template <int num_dimensions, class T1, class T2, class scaleT>
inline Array<num_dimensions, T2> convert_array(scaleT& scale_factor, const Array<num_dimensions, T1>& data_in,
