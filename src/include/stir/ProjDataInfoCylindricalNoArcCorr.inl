...
get_bin_for_det_pair(Bin& bin,
             ...
             const int det_num2, const int ring_num2, const std::pair<int,int>& energy_window_pair) const
{  
  if (get_view_tangential_pos_num_for_det_num_pair(bin.view_num(), bin.tangential_pos_num(), det_num1, det_num2))
  {
    bin.first_energy_window_num() = energy_window_pair.first;//energy_window_pair.first;
  ...
  {
    bin.first_energy_window_num()=energy_window_pair.second;
