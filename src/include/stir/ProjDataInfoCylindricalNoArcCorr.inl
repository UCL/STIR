...
void
ProjDataInfoCylindricalNoArcCorr::get_det_num_pair_for_view_tangential_pos_num(int& det1_num,
                                                                               int& det2_num,
                                                                               const int view_num,
...
bool
ProjDataInfoCylindricalNoArcCorr::get_view_tangential_pos_num_for_det_num_pair(int& view_num,
                                                                               int& tang_pos_num,
                                                                               const int det1_num,
...
Succeeded
ProjDataInfoCylindricalNoArcCorr::get_bin_for_det_pair(
    Bin& bin, const int det_num1, const int ring_num1, const int det_num2, const int ring_num2, const int timing_pos_num) const
{
...
{
  return get_bin_for_det_pair(bin,
