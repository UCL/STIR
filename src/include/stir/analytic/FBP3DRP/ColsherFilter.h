...
public:
  ...
  */
  explicit ColsherFilter(float theta_max, float alpha_colsher_axial = 1.F, float fc_colsher_axial = 0.5F,
                         float alpha_colsher_radial = 1.F, float fc_colsher_radial = 0.5F, const int stretch_factor_axial = 2,
...
#else
  ColsherFilter(int height, int width, float gamma, float theta_max, float d_a, float d_b, float alpha_colsher_axial,
                float fc_colsher_axial, float alpha_colsher_radial, float fc_colsher_radial);
#endif
