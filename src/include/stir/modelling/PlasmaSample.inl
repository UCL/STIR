...
PlasmaSample::PlasmaSample(const double sample_time, const float plasma_sample_counts, const float blood_sample_counts)
{
...
void
PlasmaSample::set_time_in_s(const double time)
{
...
double
PlasmaSample::get_time_in_s() const
{
...
void
PlasmaSample::set_blood_counts_in_kBq(const float blood_counts)
{
...
float
PlasmaSample::get_blood_counts_in_kBq() const
{
...
void
PlasmaSample::set_plasma_counts_in_kBq(const float plasma_counts)
{
...
//! get the plasma counts of the sample
float
PlasmaSample::get_plasma_counts_in_kBq() const
{
