...
template <int num_param, typename elemT>
void
KineticParameters<num_param, elemT>::set_parameter_value(const elemT param_value, const int param_num) {
...
template <int num_param, typename elemT>
elemT
KineticParameters<num_param, elemT>::get_parameter_value(const int param_num) const {
