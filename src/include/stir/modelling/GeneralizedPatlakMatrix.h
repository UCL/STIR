...
public:
  ...
  //!@}
   ...
   inline void set_prefetched_sampling(const float kloss_start,
	...
	inline void estimate_inverse_Hfunction(float& kloss_estimate,
	                                       float& Hfunction_val) const;
										   
	inline void estimate_denominator_Kifunction(float& Ki_denominator,
