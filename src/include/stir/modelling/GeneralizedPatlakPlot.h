...
class GeneralizedPatlakPlot : public RegisteredParsingObject<GeneralizedPatlakPlot, KineticModel> 
{
  ...
  static const char * const registered_name; 
    ...
    */  
    virtual void
      multiply_dynamic_image_with_model_gradient(DynamicDiscretisedDensity & impulse_response,
    ...
    */
    virtual void
      multiply_dynamic_image_with_model_gradient_and_add_to_input(DynamicDiscretisedDensity & impulse_response,
																  const DynamicDiscretisedDensity & dyn_image) const;

    virtual void
	  get_impulse_response_from_parametric_image(DynamicDiscretisedDensity & impulse_response_image,
											     const GeneralizedPatlakVoxelsOnCartesianGrid & par_image) const;
												 
	virtual void
	 get_dynamic_image_from_impulse_response(DynamicDiscretisedDensity & dyn_image,
    ...
    */
	...
	virtual void 
	  get_generalized_patlak_parameters_from_impulse_response(GeneralizedPatlakVoxelsOnCartesianGrid & par_image,
