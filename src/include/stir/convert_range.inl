...
inline void
find_scale_factor(scaleT& scale_factor, const InputIteratorT& begin, const InputIteratorT& end,
...
void
convert_range(const OutputIteratorT& out_begin, scaleT& scale_factor, const InputIteratorT& in_begin,
