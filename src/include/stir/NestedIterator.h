...
public:
  ...
  inline NestedIterator(
      ...
      : _current_top_level_iter(other._current_top_level_iter), _end_top_level_iter(other._end_top_level_iter),
        _current_rest_iter(other._current_rest_iter), _end_rest_iter(other._end_rest_iter) {}
