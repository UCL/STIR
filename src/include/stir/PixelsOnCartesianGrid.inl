...
PixelsOnCartesianGrid<elemT>::PixelsOnCartesianGrid() : DiscretisedDensityOnCartesianGrid<2, elemT>() {}

template <class elemT>
PixelsOnCartesianGrid<elemT>::PixelsOnCartesianGrid(const Array<2, elemT>& v, const CartesianCoordinate3D<float>& origin,
...
template <class elemT>
PixelsOnCartesianGrid<elemT>::PixelsOnCartesianGrid(const IndexRange<2>& range, const CartesianCoordinate3D<float>& origin,
                                                    const BasicCoordinate<2, float>& grid_spacing)
