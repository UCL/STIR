...
public:
  ...
  DynamicDiscretisedDensity(const TimeFrameDefinitions& time_frame_definitions, const double scan_start_time_in_secs_since_1970,
  ...
  DynamicDiscretisedDensity(const TimeFrameDefinitions& time_frame_definitions, const double scan_start_time_in_secs_since_1970,
                            const shared_ptr<Scanner>& scanner_sptr, const shared_ptr<singleDiscDensT>& density_sptr) {
    _densities.resize(time_frame_definitions.get_num_frames());
