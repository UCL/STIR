...
void divide_and_truncate(Viewgram<float>& numerator, const Viewgram<float>& denominator, const int rim_truncation_sino,
...
void truncate_rim(DiscretisedDensity<3, float>& image_input, const int rim_truncation_image,
...
void accumulate_loglikelihood(Viewgram<float>& projection_data, const Viewgram<float>& estimated_projections,
