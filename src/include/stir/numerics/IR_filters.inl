...
void inline IIR_filter(RandIter1 output_begin_iterator,
      ...
      for (RandIter3 current_input_factor_iterator = input_factor_begin_iterator;
           ...
           ++current_input_factor_iterator, --current_current_input_iterator)
        {
          ...
          (*current_output_iterator)
              += (*current_current_input_iterator) * static_cast<cast_type>(*current_input_factor_iterator);
#endif
...
void inline FIR_filter(RandIter1 output_begin_iterator,
                       RandIter1 output_end_iterator,
                       const RandIter2 input_begin_iterator,
                       const RandIter2 input_end_iterator,
                       const RandIter3 input_factor_begin_iterator,
                       ...
                       const bool if_initial_exists)
{
  IIR_filter(output_begin_iterator,
             output_end_iterator,
             input_begin_iterator,
             input_end_iterator,
             input_factor_begin_iterator,
             input_factor_end_iterator,
             output_begin_iterator,
             output_begin_iterator,
             if_initial_exists);
}
