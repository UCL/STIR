...
void
divide(const NumeratorIterT& numerator_begin, const NumeratorIterT& numerator_end, const DenominatorIterT& denominator_begin,
       const small_numT small_num) {
  small_numT small_value = *std::max_element(numerator_begin, numerator_end) * small_num;
