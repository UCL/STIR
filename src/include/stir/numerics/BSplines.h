...
/*! \brief enum providing constants to define the type of B-Spline used for interpolation
  \ingroup BSpline
*/
enum BSplineType { near_n, linear, quadratic, cubic, quartic, quintic, oMoms };
...
inline void BSplines_coef(RandIterOut c_begin_iterator, RandIterOut c_end_iterator, IterT input_begin_iterator,
                          IterT input_end_iterator, const constantsT z1, const constantsT z2,
