...
CartesianCoordinate3D<coordT>::CartesianCoordinate3D() : Coordinate3D<coordT>() {}
...
template <class coordT>
CartesianCoordinate3D<coordT>::CartesianCoordinate3D(const BasicCoordinate<3, coordT>& c) : base_type(c) {}
