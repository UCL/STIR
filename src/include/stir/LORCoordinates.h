...
protected:
  explicit LORCylindricalCoordinates_z_and_radius(coordT radius = 1) : _radius(radius) { check_state(); }
  LORCylindricalCoordinates_z_and_radius(coordT z1, coordT z2, coordT radius) : _radius(radius), _z1(z1), _z2(z2) {
    check_state();
  }
...
public:
  ...
  */
  ...
  inline LORInCylinderCoordinates(const LORAs2Points<coordT>&);
...
public:
  ...
  */
  ...
  inline LORInAxialAndSinogramCoordinates(const LORAs2Points<coordT>&);
#endif
...
#if __cplusplus >= 201103L
  inline LORInAxialAndNoArcCorrSinogramCoordinates(const LORAs2Points<coordT>&);
#endif
...
inline Succeeded find_LOR_intersections_with_cylinder(LORInCylinderCoordinates<coordT1>&, const LORAs2Points<coordT2>&,
                                                      const double radius);
/*! \ingroup LOR
  \brief Given an LOR, find its intersection with a (infintely long) cylinder
  \warning This is all preliminary and likely to change.
...
inline Succeeded find_LOR_intersections_with_cylinder(LORAs2Points<coordT1>& intersection_coords,
                                                      const LORAs2Points<coordT2>& coords, const double radius);
/*! \ingroup LOR
  \brief Given an LOR, find its intersection with a (infintely long) cylinder
  \warning This is all preliminary and likely to change.
*/
