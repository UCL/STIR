...
*/
void zoom_viewgrams(RelatedViewgrams<float>& viewgrams, const float zoom, const int min_tang_pos_num, const int max_tang_pos_num,
...
/*!
  ...
  \see zoom.h for parameter info
*/
void zoom_viewgram(Viewgram<float>& viewgram, const float zoom, const int min_tang_pos_num, const int max_tang_pos_num,
                   const float x_offset_in_mm = 0, const float y_offset_in_mm = 0);
/*!
 ...
 \see zoom.h for parameter info
*/
void zoom_viewgram(Viewgram<float>& out_viewgram, const Viewgram<float>& in_viewgram, const float x_offset_in_mm = 0,
...
*/
VoxelsOnCartesianGrid<float> zoom_image(const VoxelsOnCartesianGrid<float>& image, const CartesianCoordinate3D<float>& zooms,
                                        const CartesianCoordinate3D<float>& offsets_in_mm,
                                        const BasicCoordinate<3, int>& new_sizes, const ZoomOptions = ZoomOptions::preserve_sum);
...
*/
void zoom_image_in_place(VoxelsOnCartesianGrid<float>& image, const CartesianCoordinate3D<float>& zooms,
...
*/
void zoom_image(VoxelsOnCartesianGrid<float>& image_out, const VoxelsOnCartesianGrid<float>& image_in,
                const ZoomOptions = ZoomOptions::preserve_sum);
...
\a image2D_out.
   \see zoom.h for parameter info
*/
void zoom_image(PixelsOnCartesianGrid<float>& image2D_out, const PixelsOnCartesianGrid<float>& image2D_in,
                const ZoomOptions = ZoomOptions::preserve_sum);
...
/*!
  ...
  \see zoom.h for parameter info
*/
VoxelsOnCartesianGrid<float> zoom_image(const VoxelsOnCartesianGrid<float>& image, const float zoom, const float x_offset_in_mm,
                                        const float y_offset_in_mm, const int new_size,
                                        const ZoomOptions = ZoomOptions::preserve_sum);
...
/*!
  ...
  \see zoom.h for parameter info
*/
void zoom_image_in_place(VoxelsOnCartesianGrid<float>& image, const float zoom, const float x_offset_in_mm,
                         const float y_offset_in_mm, const int new_size, const ZoomOptions = ZoomOptions::preserve_sum);
