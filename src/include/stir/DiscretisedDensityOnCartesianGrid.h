...
public:
  ...
  inline DiscretisedDensityOnCartesianGrid(const IndexRange<num_dimensions>& range, const CartesianCoordinate3D<float>& origin,
  ...
  inline DiscretisedDensityOnCartesianGrid(const shared_ptr<const ExamInfo>& exam_info_sptr,
                                           const IndexRange<num_dimensions>& range, const CartesianCoordinate3D<float>& origin,
                                           const BasicCoordinate<num_dimensions, float>& grid_spacing);
...
protected:
  virtual inline bool actual_has_same_characteristics(DiscretisedDensity<num_dimensions, elemT> const&,
  ...
  */
  virtual inline CartesianCoordinate3D<float>
  ...
  /*! The input argument should be relative to the origin.
      ...
      \todo cope with non-standard orientations
  */
  virtual inline BasicCoordinate<num_dimensions, float>
