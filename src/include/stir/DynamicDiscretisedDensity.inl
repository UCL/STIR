...
DynamicDiscretisedDensity::full_iterator
DynamicDiscretisedDensity::begin_all()
{
  return full_iterator(this->_densities.begin(), this->_densities.end());
}

DynamicDiscretisedDensity::const_full_iterator
DynamicDiscretisedDensity::begin_all() const
{
  return const_full_iterator(this->_densities.begin(), this->_densities.end());
}

DynamicDiscretisedDensity::const_full_iterator
DynamicDiscretisedDensity::begin_all_const() const
{
  return const_full_iterator(this->_densities.begin(), this->_densities.end());
}

DynamicDiscretisedDensity::full_iterator
DynamicDiscretisedDensity::end_all()
{
  return full_iterator(this->_densities.end(), this->_densities.end());
}

DynamicDiscretisedDensity::const_full_iterator
DynamicDiscretisedDensity::end_all() const
{
  return const_full_iterator(this->_densities.end(), this->_densities.end());
}

DynamicDiscretisedDensity::const_full_iterator
DynamicDiscretisedDensity::end_all_const() const
{
  return const_full_iterator(this->_densities.end(), this->_densities.end());
}
