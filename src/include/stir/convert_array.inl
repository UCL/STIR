...
void
find_scale_factor(scaleT& scale_factor, const ArrayLike& data_in, const NumericInfo<T2> info_for_out_type)
{
...
Array<num_dimensions, T2, indexT>
convert_array(scaleT& scale_factor, const Array<num_dimensions, T1, indexT>& data_in, const NumericInfo<T2> info_for_out_type)
{
  Array<num_dimensions, T2, indexT> data_out(data_in.get_index_range());
...
void
convert_array(Array<num_dimensions, T2, indexT2>& data_out,
              scaleT& scale_factor,
