...
Bin::Bin() : segment(0), view(0), axial_pos(0), tangential_pos(0), timing_pos(0), bin_value(0.0f) {}

Bin::Bin(int segment_num, int view_num, int axial_pos_num, int tangential_pos_num, float bin_value)
    : segment(segment_num), view(view_num), axial_pos(axial_pos_num), tangential_pos(tangential_pos_num), timing_pos(0),
      bin_value(bin_value) {}
...
Bin::Bin(int segment_num, int view_num, int axial_pos_num, int tangential_pos_num, int timing_pos_num, float bin_value)
    : segment(segment_num), view(view_num), axial_pos(axial_pos_num), tangential_pos(tangential_pos_num),
      timing_pos(timing_pos_num), bin_value(bin_value) {}

Bin::Bin(int segment_num, int view_num, int axial_pos_num, int tangential_pos_num, int timing_pos_num)
    : segment(segment_num), view(view_num), axial_pos(axial_pos_num), tangential_pos(tangential_pos_num),
      timing_pos(timing_pos_num), bin_value(0.0f) {}
...
Bin::operator==(const Bin& bin2) const {
  return segment == bin2.segment && view == bin2.view && axial_pos == bin2.axial_pos && tangential_pos == bin2.tangential_pos &&
         timing_pos == bin2.timing_pos && bin_value == bin2.bin_value;
}
