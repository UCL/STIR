...
public:
  ...
  STIR_DEPRECATED inline void axpby(const elemT2 a, const NumericVectorWithOffset& x, const elemT2 b,
  ...
  inline void xapyb(const NumericVectorWithOffset& x, const NumericVectorWithOffset& a, const NumericVectorWithOffset& y,
