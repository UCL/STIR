...
public:
  ...
  //! \name check functions
  //@{
  inline bool has_template_proj_data_info() const { return !stir::is_null_ptr(proj_data_info_cyl_noarc_cor_sptr); }
...
protected:
  ...
  */
  ...
  //@{
  static float integral_between_2_points(const DiscretisedDensity<3, float>& density, const CartesianCoordinate3D<float>& point1,
