...
public:
    ...
    void get_jacobian(std::vector<VoxelsOnCartesianGrid<float> >  &gradient_image_array,const bool compute_gradient, const bool isgradient_mu);
    //ProjDataInMemory get_jacobian_test(VoxelsOnCartesianGrid<float>&gradient_image_array,const bool compute_gradient, const bool isgradient_mu);
    void get_ratio(const ProjData& projdata,const ProjData &add_projdata, const ProjData &est_projdata, std::vector<float> &ratio_vector);
    protected:
    ...
    void L_G_for_view_segment_number_from_est_data(const ProjData&data,VoxelsOnCartesianGrid<float>& gradient_image,const ViewSegmentNumbers& vs_num, const float rescale, const bool compute_gradient,const bool isgradient_mu);
    ...
    void get_jacobian_for_view_segment_number(std::vector<VoxelsOnCartesianGrid<float> > &gradient_image_array,const ViewSegmentNumbers& vs_num, const bool compute_gradient,const bool isgradient_mu);
