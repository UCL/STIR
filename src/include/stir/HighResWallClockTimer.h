...
inline HighResWallClockTimer::HighResWallClockTimer(void) : m_bRunning(false) { reset(); };

/*! The timer must not be running. */
inline HighResWallClockTimer::~HighResWallClockTimer(void) { assert(!m_bRunning); };
