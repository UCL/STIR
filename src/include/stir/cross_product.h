...
cross_product(const CartesianCoordinate3D<coordT>& a, const CartesianCoordinate3D<coordT>& b) {
  return CartesianCoordinate3D<coordT>(a.y() * b.x() - a.x() * b.y(), -a.z() * b.x() + a.x() * b.z(),
                                       a.z() * b.y() - a.y() * b.z());
};
