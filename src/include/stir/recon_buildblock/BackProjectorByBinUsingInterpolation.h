...
{ 
  ...
  virtual void back_project_all_symmetries(VoxelsOnCartesianGrid<float>& image, const Viewgram<float>& pos_view,
                                           ...
                                           const Viewgram<float>& neg_plus90, const Viewgram<float>& pos_min180,
                                           const Viewgram<float>& neg_min180, const Viewgram<float>& pos_min90,
                                           const Viewgram<float>& neg_min90, const int min_axial_pos_num,
  ...
  virtual void back_project_view_plus_90_and_delta(VoxelsOnCartesianGrid<float>& image, const Viewgram<float>& pos_view,
                                                   const Viewgram<float>& neg_view, const Viewgram<float>& pos_plus90,
                                                   const Viewgram<float>& neg_plus90, const int min_axial_pos_num,
                                                   const int max_axial_pos_num, const int min_tangential_pos_num,
                                                   const int max_tangential_pos_num);
  /*
...
*/
  ...
  static void piecewise_linear_interpolation_backproj3D_Cho_view_viewplus90(
      ...
      const double sphi, int s, int ax_pos0, const int num_planes_per_axial_pos, const float axial_pos_to_z_offset);
  ...
  static void
  linear_interpolation_backproj3D_Cho_view_viewplus90(Array<4, float> const& Projptr, VoxelsOnCartesianGrid<float>& image,
                                                      const shared_ptr<const ProjDataInfoCylindricalArcCorr> proj_data_info_sptr,
                                                      float delta, const double cphi, const double sphi, int s, int ax_pos0,
                                                      const int num_planes_per_axial_pos, const float axial_pos_to_z_offset);
