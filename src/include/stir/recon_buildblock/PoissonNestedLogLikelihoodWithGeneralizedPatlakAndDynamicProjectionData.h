                                ...
                                PoissonLogLikelihoodWithLinearModelForMean<TargetT> >
{
 ...
 protected:
   ...
   //It can be used either (1) for EM initialization, together with standard Patlak EM method, or (2) for regular nested EM reconstruction.
   virtual void															 
   ...
   */
  virtual void
    add_subset_initialization_sensitivity(TargetT& initialization_sensitivity, const int subset_num) const;
