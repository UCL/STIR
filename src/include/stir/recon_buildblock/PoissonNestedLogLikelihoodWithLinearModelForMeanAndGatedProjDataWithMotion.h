...
/*!
  \ingroup GeneralisedObjectiveFunction
  \brief a base class for NestedLogLikelihood of independent Poisson variables
...
\tilde{\nu}g}\Lambda_{\tilde{\nu}'}^{(s)}+\frac{B_{bg}}{A_{bg}}}\right) \end{array} \f] \par Parameters for parsing
 ...
 Based on non-nested MCIR implementation: Tsoumpas et al (2013) Physics in Medicine and Biology

*/

template <typename TargetT>
class PoissonNestedLogLikelihoodWithLinearModelForMeanAndGatedProjDataWithMotion
    : public RegisteredParsingObject<PoissonNestedLogLikelihoodWithLinearModelForMeanAndGatedProjDataWithMotion<TargetT>,
                                     GeneralisedObjectiveFunction<TargetT>,
                                     PoissonLogLikelihoodWithLinearModelForMean<TargetT>>
{
private:
  typedef RegisteredParsingObject<PoissonNestedLogLikelihoodWithLinearModelForMeanAndGatedProjDataWithMotion<TargetT>,
                                  GeneralisedObjectiveFunction<TargetT>,
                                  PoissonLogLikelihoodWithLinearModelForMean<TargetT>>
      base_type;
...
public:
  ...
  */
  ...
  // The principal nested EM reconstruction method that performs the motion correction within reconstruction
