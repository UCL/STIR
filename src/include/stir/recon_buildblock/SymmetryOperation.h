...
public:
  ...
  inline void transform_bin_coordinates(Bin& b) const {}
  inline void transform_view_segment_indices(ViewSegmentNumbers& n) const {}
  inline void transform_image_coordinates(BasicCoordinate<3, int>& c) const {}
  inline void transform_proj_matrix_elems_for_one_bin(ProjMatrixElemsForOneBin& lor) const {}
