...
#ifndef __stir_recon_buildblock_PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion_H__
#define __stir_recon_buildblock_PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion_H__
...
//#define PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion
// PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion_MPI #endif
...
/*!
  ...
  Based on non-nested STIR implementation of objective function:
  ...
  \verbatim
  PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion Parameters:=
  ...
  ; see PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion
  ; class documentation
  additive sinogram :=
  ...
  End PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion Parameters :=
  \endverbatim
*/
template <typename TargetT>
class PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion
    : public RegisteredParsingObject<PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion<TargetT>,
                                     GeneralisedObjectiveFunction<TargetT>,
                                     PoissonLogLikelihoodWithLinearModelForMean<TargetT>>
{
private:
  typedef RegisteredParsingObject<PoissonNestedLogLikelihoodWithLinearModelForMeanAndConvolvedProjDataWithMotion<TargetT>,
                                  GeneralisedObjectiveFunction<TargetT>,
                                  PoissonLogLikelihoodWithLinearModelForMean<TargetT>>
      base_type;
...
protected:
  ...
  // The principal nested EM reconstruction method that performs the RLMCIR reconstruction
...
protected:
  ...
  //! the current subiteration index
  int save_nested_subiterations_interval;
  ...
  //! convolved (motion-contaminated) image template (same as deconvolved or motion-corrected image template)
  // TargetT _conv_image_template;
