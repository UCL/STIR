...
public:
  ...
  /*! Currently this will write an interfile-type header, a file with the binary data,
      ...
      matrix back in.
  */
  static Succeeded write_to_file(const std::string& output_filename_prefix, const ProjMatrixByBin& proj_matrix,
...
private:
  ...
  virtual void calculate_proj_matrix_elems_for_one_bin(ProjMatrixElemsForOneBin&) const;
