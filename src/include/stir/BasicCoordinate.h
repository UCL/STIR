...
/*!
  \ingroup Coordinate
  \brief class BasicCoordinate\<\c int \c num_dimensions, \c typename \c coordT\> defines \c num_dimensions -dimensional
  coordinates.
...
public:
  ...
  */
  ...
  explicit inline BasicCoordinate(const BasicCoordinate<num_dimensions, coordT2>& c)
  {
...
http://groups.google.com/group/comp.lang.c%2B%2B.moderated/browse_thread/thread/e5c4898a5c259cc1/434f5a25df51781f%23434f5a25df51781f?sa=X&oi=groupsr&start=2&num=3),
  ...
  */
  ...
  //! Return value at index \c t (which is 1-based) if the BasicCoordinate object is const, but with range checking (throws
  //! std::out_of_range)
...
template <class T>
inline BasicCoordinate<1, T> make_coordinate(const T& a1);

template <class T>
inline BasicCoordinate<2, T> make_coordinate(const T& a1, const T& a2);

template <class T>
inline BasicCoordinate<3, T> make_coordinate(const T& a1, const T& a2, const T& a3);

template <class T>
inline BasicCoordinate<4, T> make_coordinate(const T& a1, const T& a2, const T& a3, const T& a4);

template <class T>
inline BasicCoordinate<5, T> make_coordinate(const T& a1, const T& a2, const T& a3, const T& a4, const T& a5);

template <class T>
inline BasicCoordinate<6, T> make_coordinate(const T& a1, const T& a2, const T& a3, const T& a4, const T& a5, const T& a6);
...
template <int num_dimensions, typename coordT>
inline coordT inner_product(const BasicCoordinate<num_dimensions, coordT>& p1, const BasicCoordinate<num_dimensions, coordT>& p2);
//! compute (inner_product(p1,p1))
/*!
  \ingroup Coordinate
  \todo move to a new CartesianCoordinate class */
template <int num_dimensions, typename coordT>
inline double norm_squared(const BasicCoordinate<num_dimensions, coordT>& p1);
//! compute sqrt(inner_product(p1,p1))
/*!
  \ingroup Coordinate
  \todo move to a new CartesianCoordinate class */
template <int num_dimensions, typename coordT>
inline double norm(const BasicCoordinate<num_dimensions, coordT>& p1);
//! compute angle between 2 directions
/*! \ingroup Coordinate
        Implemented in terms of acos(cos_angle(p1,p2)).
    \todo move to a new CartesianCoordinate class */
template <int num_dimensions, typename coordT>
inline double angle(const BasicCoordinate<num_dimensions, coordT>& p1, const BasicCoordinate<num_dimensions, coordT>& p2);
...
*/
template <int num_dimensions, typename coordT>
inline double cos_angle(const BasicCoordinate<num_dimensions, coordT>& p1, const BasicCoordinate<num_dimensions, coordT>& p2);
...
/*! \ingroup Coordinate */
template <int num_dimensions, typename coordT>
inline BasicCoordinate<num_dimensions + 1, coordT> join(const coordT& a, const BasicCoordinate<num_dimensions, coordT>& c);

//! make a longer BasicCoordinate, by appending the \c coordT to  \c c
/*! \ingroup Coordinate */
template <int num_dimensions, class coordT>
inline BasicCoordinate<num_dimensions + 1, coordT> join(const BasicCoordinate<num_dimensions, coordT>& c, const coordT& a);

//! make a shorter BasicCoordinate, by cutting the last element from \c c
/*! \ingroup Coordinate */
template <int num_dimensions, class coordT>
inline BasicCoordinate<num_dimensions - 1, coordT> cut_last_dimension(const BasicCoordinate<num_dimensions, coordT>& c);

//! make a shorter BasicCoordinate, by cutting the first element from \c c
/*! \ingroup Coordinate */
template <int num_dimensions, typename coordT>
inline BasicCoordinate<num_dimensions - 1, coordT> cut_first_dimension(const BasicCoordinate<num_dimensions, coordT>& c);

//! converts a BasicCoordinate<int> to BasicCoordinate<float>
/*! \ingroup Coordinate */
template <int num_dimensions>
inline BasicCoordinate<num_dimensions, float> convert_int_to_float(const BasicCoordinate<num_dimensions, int>& cint);
