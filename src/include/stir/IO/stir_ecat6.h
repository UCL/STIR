...
*/
VoxelsOnCartesianGrid<float>* ECAT6_to_VoxelsOnCartesianGrid(const int frame_num, const int gate_num, const int data_num,
                                                             const int bed_num, FILE* cti_fptr, const ECAT6_Main_header& mhead);
/*
...
*/
void ECAT6_to_PDFS(const int frame_num, const int gate_num, const int data_num, const int bed_num, int max_ring_diff,
                   bool arccorrected, const std::string& output_file_name, FILE* cti_fptr, const ECAT6_Main_header& mhead);
...
/*! \ingroup ECAT*/
Succeeded DiscretisedDensity_to_ECAT6(DiscretisedDensity<3, float> const& density, std::string const& cti_name,
...
/*!
  ...
  */
Succeeded DiscretisedDensity_to_ECAT6(FILE* fptr, DiscretisedDensity<3, float> const& density, const ECAT6_Main_header& mhead,
                                      const int frame_num = 1, const int gate_num = 1, const int data_num = 0,
                                      const int bed_num = 0);
 ...
 */
Succeeded ProjData_to_ECAT6(ProjData const& proj_data, std::string const& cti_name, std::string const& orig_name,
                            const int frame_num = 1, const int gate_num = 1, const int data_num = 0, const int bed_num = 0,
...
/*!
  ...
  \warning This does NOT write the main header.
*/
Succeeded ProjData_to_ECAT6(FILE* fptr, ProjData const& proj_data, const ECAT6_Main_header& mhead, const int frame_num = 1,
                            const int gate_num = 1, const int data_num = 0, const int bed_num = 0,
                            const bool write_2D_sinograms = false);
...
void make_ECAT6_Main_header(ECAT6_Main_header& mhead, Scanner const& scanner, const std::string& orig_name,
