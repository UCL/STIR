...
unsigned long int
InputStreamFromROOTFile::get_total_number_of_events() const {
  return nentries;
}

Succeeded
InputStreamFromROOTFile::reset() {
  current_position = starting_stream_position;
  return Succeeded::yes;
}

InputStreamFromROOTFile::SavedPosition
InputStreamFromROOTFile::save_get_position() {
...
Succeeded
InputStreamFromROOTFile::set_get_position(const InputStreamFromROOTFile::SavedPosition& pos) {
...
InputStreamFromROOTFile::get_saved_get_positions() const {
  return saved_get_positions;
}

void
InputStreamFromROOTFile::set_saved_get_positions(const std::vector<unsigned long>& poss) {
  saved_get_positions = poss;
}

float
InputStreamFromROOTFile::get_low_energy_thres() const {
  return low_energy_window;
}

float
InputStreamFromROOTFile::get_up_energy_thres() const {
  return up_energy_window;
}

std::string
InputStreamFromROOTFile::get_ROOT_filename() const {
...
int
InputStreamFromROOTFile::get_num_axial_crystals_per_block_v() const {
...
int
InputStreamFromROOTFile::get_num_virtual_axial_crystals_per_block() const {
  return this->num_virtual_axial_crystals_per_block;
}
int
InputStreamFromROOTFile::get_num_virtual_transaxial_crystals_per_block() const {
