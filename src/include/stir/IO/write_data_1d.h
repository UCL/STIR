...
inline Succeeded write_data_1d(std::ostream& s, const Array<1, elemT>& data, const ByteOrder byte_order,
 ...
 */
template <class elemT>
inline Succeeded write_data_1d(FILE*& fptr_ref, const Array<1, elemT>& data, const ByteOrder byte_order,
                               const bool can_corrupt_data);
} // namespace detail
