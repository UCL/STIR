...
InputStreamWithRecords<RecordT, OptionsT>::InputStreamWithRecords(const shared_ptr<std::istream>& stream_ptr,
                                                                  ...
                                                                  const std::size_t max_size_of_record, const OptionsT& options)
    : stream_ptr(stream_ptr), size_of_record_signature(size_of_record_signature), max_size_of_record(max_size_of_record),
      options(options) {
...
InputStreamWithRecords<RecordT, OptionsT>::InputStreamWithRecords(const std::string& filename,
    ...
    : filename(filename), starting_stream_position(start_of_data), size_of_record_signature(size_of_record_signature),
      max_size_of_record(max_size_of_record), options(options) {
  assert(size_of_record_signature <= max_size_of_record);
...
InputStreamWithRecords<RecordT, OptionsT>::get_next_record(RecordT& record) const {
  ...
  if (size_of_record > this->size_of_record_signature)
    stream_ptr->read(data_ptr + this->size_of_record_signature, size_of_record - this->size_of_record_signature);
  if (stream_ptr->eof())
    return Succeeded::no;
  ...
  return record.init_from_data_ptr(data_ptr, size_of_record, options);
}
