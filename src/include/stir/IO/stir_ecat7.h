...
/*!
  \ingroup ECAT
*/
Succeeded DiscretisedDensity_to_ECAT7(DiscretisedDensity<3, float> const& density, std::string const& cti_name,
                                      std::string const& orig_name, const Scanner& scanner, const int frame_num = 1,
                                      const int gate_num = 1, const int data_num = 0, const int bed_num = 0);
...
/*!
  ...
  */
Succeeded DiscretisedDensity_to_ECAT7(MatrixFile* mptr, DiscretisedDensity<3, float> const& density, const int frame_num = 1,
                                      const int gate_num = 1, const int data_num = 0, const int bed_num = 0);
...
*/
Succeeded ProjData_to_ECAT7(ProjData const& proj_data, NumericType output_type, std::string const& cti_name,
                            std::string const& orig_name, const int frame_num = 1, const int gate_num = 1, const int data_num = 0,
                            const int bed_num = 0, const bool write_as_attenuation = false, float scale_factor = 0.0F);
...
/*!
  ...
  \warning This does NOT write the main header.
*/
Succeeded ProjData_to_ECAT7(MatrixFile* mptr, ProjData const& proj_data, const int frame_num = 1, const int gate_num = 1,
                            const int data_num = 0, const int bed_num = 0, float scale_factor = 0.0F);
...
void make_ECAT7_main_header(Main_header& mhead, Scanner const& scanner, const std::string& orig_name,
...
*/
NumericType make_ECAT7_main_header(Main_header& mhead, const std::string& orig_name, ExamInfo const& exam_info,
                                   ProjDataInfo const& proj_data_info, const bool write_as_attenuation = false,
...
*/
ProjDataFromStream* make_pdfs_from_matrix(MatrixFile* const mptr, MatrixData* const matrix,
...
*/
Succeeded write_basic_interfile_header_for_ECAT7(std::string& interfile_header_name, const std::string& ECAT7_filename,
...
*/
VoxelsOnCartesianGrid<float>* ECAT7_to_VoxelsOnCartesianGrid(const std::string& ECAT7_filename, const int frame_num,
...
*/
ProjDataFromStream* ECAT7_to_PDFS(const std::string& ECAT7_filename, const int frame_num, const int gate_num, const int data_num,
                                  const int bed_num);
