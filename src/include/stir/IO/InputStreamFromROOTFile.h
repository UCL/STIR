...
public:
 ...
 protected:
    ...
    //! Lower energy threshold photon 1. Default is 1000 (keV)
    float low_energy_window_1;
    //! Upper energy threshold photon 1. Default is 0 (keV)
    float up_energy_window_1;
    //! Lower energy threshold photon 2. Default is 1000 (keV)
    float low_energy_window_2;
    //! Upper energy threshold photon 2. Default is 0 (keV)
