...
template <int num_dimensions, class IStreamT, class elemT>
inline Succeeded
read_data(IStreamT& s, Array<num_dimensions, elemT>& data, const ByteOrder byte_order ___BYTEORDER_DEFAULT) {
...
inline Succeeded
read_data(IStreamT& s, Array<num_dimensions, elemT>& data, NumericInfo<InputType> input_type, ScaleT& scale_factor,
...
inline Succeeded
read_data(IStreamT& s, Array<num_dimensions, elemT>& data, NumericType type, ScaleT& scale,
          const ByteOrder byte_order ___BYTEORDER_DEFAULT) {
  switch (type.id) {
