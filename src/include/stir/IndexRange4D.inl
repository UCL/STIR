...
IndexRange4D::IndexRange4D() : base_type() {}

IndexRange4D::IndexRange4D(const IndexRange<4>& range_v) : base_type(range_v) {}

IndexRange4D::IndexRange4D(const int min_1, const int max_1, const int min_2, const int max_2, const int min_3, const int max_3,
