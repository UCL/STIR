 ...
 *
 * \par Description
 * This class provides basic filesystem support for STIR. It is build in a similar manner to the functions in the utilities but
 * extends with support to create folders, check if folder exists and is writable.
 *
