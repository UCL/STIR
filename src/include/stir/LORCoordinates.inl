...
template <class coordT>
PointOnCylinder<coordT>::PointOnCylinder(const coordT z, const coordT psi) : _z(z), _psi(psi) {}

template <class coordT>
LORInCylinderCoordinates<coordT>::LORInCylinderCoordinates(const coordT radius) : _radius(radius) {}

template <class coordT>
LORInCylinderCoordinates<coordT>::LORInCylinderCoordinates(const PointOnCylinder<coordT>& p1, const PointOnCylinder<coordT>& p2,
                                                           const coordT radius)
...
LORInAxialAndSinogramCoordinates<coordT>::LORInAxialAndSinogramCoordinates(const coordT radius)
    : LORCylindricalCoordinates_z_and_radius<coordT>(radius), _phi(0), _s(0),
...
template <class coordT>
LORInAxialAndSinogramCoordinates<coordT>::LORInAxialAndSinogramCoordinates(const coordT z1, const coordT z2, const coordT phi,
                                                                           const coordT s, const coordT radius,
                                                                           const bool swapped)
    : LORCylindricalCoordinates_z_and_radius<coordT>(z1, z2, radius), _phi(phi), _s(s), _swapped(swapped) {
  check_state();
}

template <class coordT>
LORInAxialAndNoArcCorrSinogramCoordinates<coordT>::LORInAxialAndNoArcCorrSinogramCoordinates(const coordT radius)
    : LORCylindricalCoordinates_z_and_radius<coordT>(radius), _phi(0), _beta(0),
...
template <class coordT>
LORInAxialAndNoArcCorrSinogramCoordinates<coordT>::LORInAxialAndNoArcCorrSinogramCoordinates(const coordT z1, const coordT z2,
                                                                                             const coordT phi, const coordT beta,
                                                                                             const coordT radius,
                                                                                             const bool swapped)
    : LORCylindricalCoordinates_z_and_radius<coordT>(z1, z2, radius), _phi(phi), _beta(beta), _swapped(swapped)
...
template <class coordT>
static inline void
get_sino_coords(coordT& _z1, coordT& _z2, coordT& _phi, coordT& _beta, bool& _swapped,
...
LORInAxialAndSinogramCoordinates<coordT>::LORInAxialAndSinogramCoordinates(
    ...
    : LORCylindricalCoordinates_z_and_radius<coordT>(coords.z1(), coords.z2(), coords.radius()), _phi(coords.phi()),
      _s(coords.s()), _swapped(coords.is_swapped()) {
  check_state();
}
...
LORInAxialAndNoArcCorrSinogramCoordinates<coordT>::LORInAxialAndNoArcCorrSinogramCoordinates(
    ...
    : LORCylindricalCoordinates_z_and_radius<coordT>(coords.z1(), coords.z2(), coords.radius()), _phi(coords.phi()),
      _beta(coords.beta()), _swapped(coords.is_swapped()) {
  check_state();
}

#if __cplusplus >= 201103L
template <class coordT>
LORInAxialAndSinogramCoordinates<coordT>::LORInAxialAndSinogramCoordinates(const LORAs2Points<coordT>& coords)
    : LORInAxialAndSinogramCoordinates(LORInCylinderCoordinates<coordT>(coords)) {}

template <class coordT>
LORInAxialAndNoArcCorrSinogramCoordinates<coordT>::LORInAxialAndNoArcCorrSinogramCoordinates(const LORAs2Points<coordT>& coords)
...
Succeeded
find_LOR_intersections_with_cylinder(LORAs2Points<coordT1>& intersection_coords, const LORAs2Points<coordT2>& coords,
                                     const double radius) {
...
template <class coordT1, class coordT2>
Succeeded
find_LOR_intersections_with_cylinder(LORInCylinderCoordinates<coordT1>& cyl_coords, const LORAs2Points<coordT2>& cart_coords,
                                     const double radius) {
...
find_LOR_intersections_with_cylinder(LORInAxialAndNoArcCorrSinogramCoordinates<coordT1>& lor,
                                     const LORAs2Points<coordT2>& cart_coords, const double radius) {
...
template <class coordT1, class coordT2>
Succeeded
find_LOR_intersections_with_cylinder(LORInAxialAndSinogramCoordinates<coordT1>& lor, const LORAs2Points<coordT2>& cart_coords,
                                     const double radius) {
  LORInCylinderCoordinates<coordT1> cyl_coords;
  if (find_LOR_intersections_with_cylinder(cyl_coords, cart_coords, radius) == Succeeded::no)
    return Succeeded::no;
