...
public:
  ...
  map_element(KeyArgument::type t, void (KeyParser::*object_member_ptr)(), void* variable_ptr, const int vectorised_key_level,
  ...
  */
  ...
  void add_parsing_key(const std::string& keyword, ParsingClass** parsed_object_ptr_ptr) {
    add_in_keymap(keyword,
                  map_element(&KeyParser::set_parsing_object, reinterpret_cast<RegisteredObjectBase**>(parsed_object_ptr_ptr),
  ...
  void add_parsing_key(const std::string& keyword, shared_ptr<ParsingClass>* parsed_object_ptr_ptr) {
    add_in_keymap(keyword, map_element(&KeyParser::set_shared_parsing_object,
...
protected:
  ...
  */
  ...
  void add_key(const std::string& keyword, KeyArgument::type t, KeywordProcessor function, void* variable = 0,
  ...
  /*! This provides a more flexible way to add keys with specific call_backs.
      ...
      pointer to member function.
      \warning this interface to KeyParser will change in a future release */
  void add_key(const std::string& keyword, KeyArgument::type t, KeywordProcessor function, void* variable,
               const int vectorised_key_level, const ASCIIlist_type* const list = 0);
  ...
  //! version that defaults 'function' to set_variable
  /*! \warning this interface to KeyParser will change in a future release */
  void add_key(const std::string& keyword, KeyArgument::type t, void* variable, const int vectorised_key_level,
               const ASCIIlist_type* const list = 0);
