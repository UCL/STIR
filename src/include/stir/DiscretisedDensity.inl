...
DiscretisedDensity<num_dimensions, elemT>::DiscretisedDensity(const IndexRange<num_dimensions>& range_v,
    ...
    : Array<num_dimensions, elemT>(range_v), origin(origin_v) {}
...
DiscretisedDensity<num_dimensions, elemT>::DiscretisedDensity(const shared_ptr<const ExamInfo>& exam_info_sptr,
                                                              ...
                                                              const CartesianCoordinate3D<float>& origin_v)
    : ExamData(exam_info_sptr), Array<num_dimensions, elemT>(range_v), origin(origin_v) {}
...
template <int num_dimensions, typename elemT>
bool
DiscretisedDensity<num_dimensions, elemT>::has_same_characteristics(
    DiscretisedDensity<num_dimensions, elemT> const& other) const {
