...
public:
  ...
  inline bool is_time() const { // TODO need to find out how to see if it's a timing event
...
public:
  ...
  */
  ...
  bool is_event() const { return this->event_data.is_event(); }
...
dynamic_cast<CListRecordGEHDF5 const *>(&e2) != 0 &&
  ...
  virtual void set_detection_position(const DetectionPositionPair<>&) { error("TODO"); }
