...
/*!
  \file
  \ingroup listmode
  \brief Declarations of class stir::SPECTListGatingInput, which
...
#ifndef __stir_listmode_SPECTListGatingInput_H__
#define __stir_listmode_SPECTListGatingInput_H__
...
*/
class SPECTListGatingInput
{
public:
  virtual ~SPECTListGatingInput() {}
