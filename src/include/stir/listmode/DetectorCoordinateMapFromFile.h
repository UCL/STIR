...
public:
  ...
  DetectorCoordinateMapFromFile(const std::string& filename, double sigma = 0.0) : sigma(sigma), distribution(0.0, sigma) {
...
private:
  struct ihash : std::unary_function<stir::DetectionPosition<>, std::size_t> {
