...
/*!
  ...
  SPECTListModeData::SavedPosition start_of_this_frame =
  ...
  This class (and SPECTListRecord) is specific to SPET, i.e. to
  ...
  derived classes of SPECTListModeData, SPECTListRecord etc. You also have to modify
  make sure that read_from_file<SPECTListModeData> recognises your data. This
...
public:
  ...
  /*! This name is not necessarily unique, and might be empty. However, it is expected
      ...
      <code>SPECTListModeData::read_from_file(lm_data_ptr-\>get_name())</code> would read
...
//  virtual bool has_delayeds() const = 0;
  ...
  {
      error("SPECTListModeData: The function get_total_number_of_events() is currently not supported for this file format.");
      return 0;
  }
