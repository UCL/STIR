...
public:
  ...
  */
  ...
  const_iterator begin() const { return this->_singles.begin(); }

  iterator begin() { return this->_singles.begin(); }

  const_iterator end() const { return this->_singles.end(); }

  iterator end() { return this->_singles.end(); }
...
public:
  ...
  */
  virtual float get_singles_rate(const int singles_bin_index, const double start_time, const double end_time) const = 0;
