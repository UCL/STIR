...
main(int argc, const char* argv[]) {
  ...
  stir::ProjDataInterfile output_proj_data(data_to_fit_proj_data_sptr->get_exam_info_sptr(), data_to_fit_proj_data_info_sptr,
                                           output_filename);

  stir::ScatterEstimation::upsample_and_fit_scatter_estimate(
      output_proj_data, *data_to_fit_proj_data_sptr, *data_to_scale_proj_data_sptr, *normalisation_sptr, *weights_proj_data_sptr,
      min_scale_factor, max_scale_factor, half_filter_width, spline_type, remove_interleaving);
  return EXIT_SUCCESS;
}
