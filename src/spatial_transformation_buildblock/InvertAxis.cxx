...
void
InvertAxis::invert_axis(DiscretisedDensity<3, float>& inverted_image, const DiscretisedDensity<3, float>& input_image,
...
int
InvertAxis::invert_axis_index(const int input_index, const int size, const std::string& axis_name) {
