...
main(int argc, char* argv[]) {
  ...
  FrameSinglesRates frame_singles_rates = singles_from_sgl.get_rates_for_frame(start_time, end_time);
  ...
  for (int singles_bin = 0; singles_bin < total_singles_units; ++singles_bin) {
    output << singles_bin << "  " << frame_singles_rates.get_singles_rate(singles_bin) << '\n';
  }
