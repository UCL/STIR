        ...
        for (std::vector<double>::const_iterator iter = sample_times.begin(); iter != sample_times.end(); ++iter)
          {
            ...
            const double RMSE_within_frame = RigidObject3DTransformation::RMSE(current_transformation_to_frame_ref,
                                                                               this->reference_points.begin(),
                                                                               this->reference_points.end(),
                                                                               this->reference_points.begin());

            const double RMSE_from_ref = RigidObject3DTransformation::RMSE(current_transformation_to_reference,
                                                                           this->reference_points.begin(),
                                                                           this->reference_points.end(),
                                                                           this->reference_points.begin());
