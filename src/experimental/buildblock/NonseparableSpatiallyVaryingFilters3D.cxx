...
void construct_scaled_filter_coefficients_3D(Array<3, float>& new_filter_coefficients_2D_array,
                                             Array<3, float>& kernel_3d,
  ...
  if (kapa0_over_kapa1 != 0)
    {
      ...
      Array<3, float> filter_coefficients(IndexRange3D(kernel_3d.get_min_index(),
                                                       kernel_3d.get_max_index(),
                                                       kernel_3d[0].get_min_index(),
                                                       kernel_3d[0].get_max_index(),
                                                       kernel_3d[0][0].get_min_index(),
                                                       kernel_3d[0][0].get_max_index()));
      ...
      if (sq_kapas > 10000)
	    ...
	    for ( int k = 1; k<=size_z;k++)
	    {
	      ...
	      cerr << endl;
              ...
              for (int i = new_filter_coefficients_3D_array_tmp[kx][jx].get_min_index();
                   i <= new_filter_coefficients_3D_array_tmp[kx][jx].get_max_index() / 2;
                   i++)
                {
              ...
              int iy = new_filter_coefficients_3D_array_tmp[ky][new_filter_coefficients_3D_array_tmp.get_min_index()]
                           .get_min_index();
              for (int j = new_filter_coefficients_3D_array_tmp[ky].get_min_index();
                   j <= new_filter_coefficients_3D_array_tmp[ky].get_max_index() / 2;
                   j++)
                {
              ...
              if (size_z == 1)
              ...
              else
                {
                  ...
                  int iz = new_filter_coefficients_3D_array_tmp[jz][new_filter_coefficients_3D_array_tmp.get_min_index()]
                               .get_min_index();
                  for (int k = new_filter_coefficients_3D_array_tmp.get_min_index();
                       k <= new_filter_coefficients_3D_array_tmp.get_max_index() / 2;
                       k++)
                    {
              ...
              if (kernel_length_x == size_x / 2)
                {
                  warning(
                      "NonseparableSpatiallyVaryingFilters3D: kernel_length_x reached maximum length %d. "
                ...
                {
                  warning(
                      "NonseparableSpatiallyVaryingFilters3D: kernel_length_y reached maximum length %d. "
                      "First filter coefficient %g, last %g, kappa0_over_kappa1 was %g\n"
                      "Increasing length of FFT array to resolve this problem\n",
                      kernel_length_y,
                      new_filter_coefficients_3D_array_tmp[new_filter_coefficients_3D_array_tmp.get_min_index()]
                ...
                {
                  warning(
                      "NonseparableSpatiallyVaryingFilters3D: kernel_length_z reached maximum length %d. "
                      "First filter coefficient %g, last %g, kappa0_over_kappa1 was %g\n"
                      "Increasing length of FFT array to resolve this problem\n",
                      kernel_length_z,
                      new_filter_coefficients_3D_array_tmp[new_filter_coefficients_3D_array_tmp.get_min_index()]
      ...
      else // sq_kappas == 1
        {
          ...
          new_filter_coefficients_3D_array.grow(IndexRange3D(min_index_z,
                                                             min_index_z + size_z - 1,
                                                             min_index_y,
                                                             min_index_y + size_y - 1,
                                                             min_index_x,
  ...
  if (recompute_every_num_subiterations > 0 && count > recompute_from_subiteration_num
      && count % recompute_every_num_subiterations == 0)
    {
      ...
      precompute_filter_coefficients_for_second_apporach(
          *precomputed_coefficients_image_cast, in_density_cast_0, *sensitivity_image_cast, *normalised_bck_image_cast);
    }
...
NonseparableSpatiallyVaryingFilters3D<elemT>::post_processing()
{
  ...
  filter_coefficients.grow(IndexRange3D(
      min_index_z, min_index_z + size_z - 1, min_index_y, min_index_y + size_y - 1, min_index_x, min_index_x + size_x - 1));
