                      ...
                      if (do_attenuation)
                        {
                          float bin_attenuation
                              = (*attenuation_segmnets[element_ptr->segment_num()])[element_ptr->view_num()]
                                                                                   [element_ptr->axial_pos_num()]
                                                                                   [element_ptr->tangential_pos_num()];
...

{
  ...
  do_segments_densels_fwd(
      in_density_cast_0, *proj_data_ptr, all_segments, min_z, max_z, min_y, max_y, min_x, max_x, *proj_matrix_ptr);
}
