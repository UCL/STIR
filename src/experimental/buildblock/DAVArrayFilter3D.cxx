...
template <typename elemT>
void
DAVArrayFilter3D<elemT>::do_it(Array<3, elemT>& out_array, const Array<3, elemT>& in_array) const {
...
template <typename elemT>
void
DAVArrayFilter3D<elemT>::extract_neighbours_and_average(elemT& out_elem, const Array<3, elemT>& in_array,
  ...
  */
  Array<1, float>::difference_type min_abs_diff_idx =
      min_element(averaged_arrays_subtracted3D.begin(), averaged_arrays_subtracted3D.end()) -
...
template <typename elemT>
bool
DAVArrayFilter3D<elemT>::is_trivial() const {
