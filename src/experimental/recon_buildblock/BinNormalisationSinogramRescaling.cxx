...
BinNormalisationSinogramRescaling::BinNormalisationSinogramRescaling()
{
  set_defaults();
}
...
float
BinNormalisationSinogramRescaling::get_bin_efficiency(const Bin& bin,
...
void
BinNormalisationSinogramRescaling::undo(RelatedViewgrams<float>& viewgrams, const double start_time, const double end_time) const
{
  for (RelatedViewgrams<float>::iterator iter = viewgrams.begin(); iter != viewgrams.end(); ++iter)
