...
QuaternionTests::run_tests() {
  ...
  cerr << "Testing inverse()" << endl;
  {
    ...
    float dot_product = (test_inverse[1] * test_inverse[1]) + (test_inverse[2] * test_inverse[2]) +
                        (test_inverse[3] * test_inverse[3]) + (test_inverse[4] * test_inverse[4]);
    Quaternion<float> result_inverse = test_inverse;
    result_inverse[1] /= dot_product;
    result_inverse[2] *= -1;
    result_inverse[2] /= dot_product;
    result_inverse[3] *= -1;
    result_inverse[3] /= dot_product;
    result_inverse[4] *= -1;
    result_inverse[4] /= dot_product;
