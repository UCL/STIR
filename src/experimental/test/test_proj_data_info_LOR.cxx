...
main(int argc, char* argv[])
{
  ...
  shared_ptr<ProjDataInfo> proj_data_info_sptr
      = ProjDataInfo::ProjDataInfoCTI(scanner_sptr,
                                      /*span*/ 3,
                                      1, // can only handle segment 0 right now
  ...
  while (argc > 0)
    {
      ...
      int ring2_90;
       ...
       proj_data_cyl_no_arc_ptr->get_det_pair_for_bin(det1_90, ring1_90,
						      ...
						      bin90);
#else
      proj_data_cyl_no_arc_ptr->get_det_num_pair_for_view_tangential_pos_num(
          det1_0, det2_0, bin0.view_num(), bin0.tangential_pos_num());
      // warning: dangerous:
      ...
      proj_data_cyl_no_arc_ptr->get_det_num_pair_for_view_tangential_pos_num(
          det1_90, det2_90, bin90.view_num(), bin90.tangential_pos_num());
      ring1_90 = bin90.axial_pos_num() / 2;
      ring2_90 = bin90.axial_pos_num() / 2;

      Bin bin_check_90;
      const DetectionPositionPair<> det_pos_pair_90(DetectionPosition<>(det1_90, ring1_90),
                                                    DetectionPosition<>(det2_90, ring2_90));
      ...
      const float distance_between_LORs = coordinate_between_2_lines(
          intersection, LORAs2Points<float>(coord_1_0, coord_2_0), LORAs2Points<float>(coord_1_90, coord_2_90));
