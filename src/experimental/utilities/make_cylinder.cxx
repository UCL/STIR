...
main(int argc, char** argv) {
  ...
  */
  ...
  VoxelsOnCartesianGrid<float> image(IndexRange3D(min_plane, max_plane, min_y_dir, max_y_dir, min_x_dir, max_x_dir), origin,
                                     voxel_size);
  ...
  const CartesianCoordinate3D<float> cyl_origin(origin_z + centre_z, shift_y + origin_z * velocity_y,
