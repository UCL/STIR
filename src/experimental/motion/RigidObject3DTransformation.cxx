...
#  endif
  ...
  const CartesianCoordinate3D<float> transformed_point(
      out[out.get_max_index()], out[out.get_min_index() + 1], out[out.get_min_index()]);
...
void
RigidObject3DTransformation::transform_bin(Bin& bin,
...
template <class Iter1T, class Iter2T>
double
RigidObject3DTransformation::RMSE(const RigidObject3DTransformation& transformation,
...
template <class Iter1T, class Iter2T>
Succeeded
RigidObject3DTransformation::find_closest_transformation(RigidObject3DTransformation& result,
                                                         Iter1T start_orig_points,
                                                         Iter1T end_orig_points,
                                                         Iter2T start_transformed_points,
