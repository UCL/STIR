...
#if 1
  if (std::sscanf(line.c_str() + position,
                  "FRAME%d %f %f %f FRAME%d %f %f %f",
                  &frame_num1,
                  &current_voxel_coords.x(),
                  &current_voxel_coords.y(),
                  &current_voxel_coords.z(),
                  &frame_num2,
                  &new_voxel_coords.x(),
                  &new_voxel_coords.y(),
                  &new_voxel_coords.z())
  ...
  for (int i = 1; i <= num_dimensions; ++i)
    {
      BasicCoordinate<num_dimensions, elemT> gradient
          = this->interpolator[i].gradient(point_in_grid_coords) / this->_grid_spacing;
