...
const char* const BackProjectorByBinUsingSquareProjMatrixByBin::registered_name = "Matrix Square";

void
BackProjectorByBinUsingSquareProjMatrixByBin::set_defaults() {
  this->proj_matrix_ptr.reset();
}

BackProjectorByBinUsingSquareProjMatrixByBin::BackProjectorByBinUsingSquareProjMatrixByBin(
...
void
BackProjectorByBinUsingSquareProjMatrixByBin::actual_back_project(DiscretisedDensity<3, float>& image,
...
void
BackProjectorByBinUsingSquareProjMatrixByBin::initialise_keymap() {
...
BackProjectorByBinUsingSquareProjMatrixByBin::BackProjectorByBinUsingSquareProjMatrixByBin() { set_defaults(); }

void
BackProjectorByBinUsingSquareProjMatrixByBin::set_up(const shared_ptr<const ProjDataInfo>& proj_data_info_ptr,
