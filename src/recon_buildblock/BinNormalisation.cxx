...
BinNormalisation::BinNormalisation() : _already_set_up(false) {}
...
Succeeded
BinNormalisation::set_up(const shared_ptr<const ExamInfo>& exam_info_sptr,
...
BinNormalisation::apply(ProjData& proj_data, shared_ptr<DataSymmetriesForViewSegmentNumbers> symmetries_sptr) const {
  ...
  const std::vector<ViewSegmentNumbers> vs_nums_to_process = detail::find_basic_vs_nums_in_subset(
      *proj_data.get_proj_data_info_sptr(), *symmetries_sptr, proj_data.get_min_segment_num(), proj_data.get_max_segment_num(), 0,
