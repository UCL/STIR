...
template <typename elemT>
void
RelativeDifferencePrior<elemT>::check(DiscretisedDensity<3, elemT> const& current_image_estimate) const
{
  // Do base-class check
...
template <>
const char* const RelativeDifferencePrior<float>::registered_name = "Relative Difference Prior";
...
template <typename elemT>
bool
RelativeDifferencePrior<elemT>::is_convex() const
{
  return true;
}
...
template <typename elemT>
float
RelativeDifferencePrior<elemT>::get_gamma() const
{
  return this->gamma;
}
...
template <typename elemT>
void
RelativeDifferencePrior<elemT>::set_gamma(float g)
{
  this->gamma = g;
}
...
template <typename elemT>
float
RelativeDifferencePrior<elemT>::get_epsilon() const
{
  return this->epsilon;
}
...
template <typename elemT>
void
RelativeDifferencePrior<elemT>::set_epsilon(float g)
{
  this->epsilon = g;
}

template <typename elemT>
RelativeDifferencePrior<elemT>::RelativeDifferencePrior(const bool only_2D_v,
                                                        float penalisation_factor_v,
                                                        float gamma_v,
                                                        float epsilon_v)
    : only_2D(only_2D_v)
{
...
template <typename elemT>
Array<3, float>
RelativeDifferencePrior<elemT>::get_weights() const
{
  return this->weights;
}
...
RelativeDifferencePrior<elemT>::get_kappa_sptr() const
{
...
template <typename elemT>
void
RelativeDifferencePrior<elemT>::compute_gradient(DiscretisedDensity<3, elemT>& prior_gradient,
...
template <typename elemT>
void
RelativeDifferencePrior<elemT>::compute_Hessian(DiscretisedDensity<3, elemT>& prior_Hessian_for_single_densel,
...
template <typename elemT>
void
RelativeDifferencePrior<elemT>::add_multiplication_with_approximate_Hessian(DiscretisedDensity<3, elemT>& output,
...
template <typename elemT>
void
RelativeDifferencePrior<elemT>::accumulate_Hessian_times_input(DiscretisedDensity<3, elemT>& output,
