...
BinNormalisationWithCalibration::BinNormalisationWithCalibration() { set_defaults(); }
...
void
BinNormalisationWithCalibration::set_branching_ratio(const float br) {
  this->branching_ratio = br;
}

void
BinNormalisationWithCalibration::set_radionuclide(const std::string& rnuclide) {
