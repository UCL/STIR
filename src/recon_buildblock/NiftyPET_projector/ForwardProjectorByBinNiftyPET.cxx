...
//////////////////////////////////////////////////////////
const char* const ForwardProjectorByBinNiftyPET::registered_name = "NiftyPET";

ForwardProjectorByBinNiftyPET::ForwardProjectorByBinNiftyPET() : _cuda_device(0), _cuda_verbosity(true), _use_truncation(false) {
...
void
ForwardProjectorByBinNiftyPET::initialise_keymap() {
...
void
ForwardProjectorByBinNiftyPET::set_up(const shared_ptr<const ProjDataInfo>& proj_data_info_sptr,
...
ForwardProjectorByBinNiftyPET::get_symmetries_used() const {
...
void
ForwardProjectorByBinNiftyPET::actual_forward_project(RelatedViewgrams<float>&, const DiscretisedDensity<3, float>&, const int,
                                                      const int, const int, const int) {
  throw std::runtime_error("Need to use set_input() if wanting to use ForwardProjectorByBinNiftyPET.");
}

void
ForwardProjectorByBinNiftyPET::actual_forward_project(RelatedViewgrams<float>& viewgrams, const int, const int, const int,
                                                      const int) {
...
void
ForwardProjectorByBinNiftyPET::set_input(const DiscretisedDensity<3, float>& density) {
