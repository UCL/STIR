...
//////////////////////////////////////////////////////////
const char* const BackProjectorByBinNiftyPET::registered_name = "NiftyPET";

BackProjectorByBinNiftyPET::BackProjectorByBinNiftyPET() : _cuda_device(0), _cuda_verbosity(true), _use_truncation(false) {
...
void
BackProjectorByBinNiftyPET::initialise_keymap() {
...
void
BackProjectorByBinNiftyPET::set_up(const shared_ptr<const ProjDataInfo>& proj_data_info_sptr,
  ...
  // Get span
  shared_ptr<const ProjDataInfoCylindricalNoArcCorr> proj_data_info_cy_no_ar_cor_sptr(
      dynamic_pointer_cast<const ProjDataInfoCylindricalNoArcCorr>(proj_data_info_sptr));
...
BackProjectorByBinNiftyPET::get_symmetries_used() const {
...
void
BackProjectorByBinNiftyPET::back_project(const ProjData& proj_data, int subset_num, int num_subsets) {
...
void
BackProjectorByBinNiftyPET::get_output(DiscretisedDensity<3, float>& density) const {
  // --------------------------------------------------------------- //
...
void
BackProjectorByBinNiftyPET::start_accumulating_in_new_target() {
  // Call base level
...
void
BackProjectorByBinNiftyPET::actual_back_project(const RelatedViewgrams<float>& related_viewgrams, const int, const int, const int,
                                                const int) {
