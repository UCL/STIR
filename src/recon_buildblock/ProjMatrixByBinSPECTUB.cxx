...
ProjMatrixByBinSPECTUB::ProjMatrixByBinSPECTUB() { set_defaults(); }
...
void
ProjMatrixByBinSPECTUB::set_resolution_model(const float collimator_sigma_0_in_mm, const float collimator_slope_in_mm,
                                             const bool full_3D) {
...
void
ProjMatrixByBinSPECTUB::compute_one_subset(const int kOS) const {
  using namespace SPECTUB;
