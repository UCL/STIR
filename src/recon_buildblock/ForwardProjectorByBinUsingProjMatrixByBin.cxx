...
//////////////////////////////////////////////////////////
const char* const ForwardProjectorByBinUsingProjMatrixByBin::registered_name = "Matrix";

void
ForwardProjectorByBinUsingProjMatrixByBin::set_defaults() {
  this->proj_matrix_ptr.reset();
  ForwardProjectorByBin::set_defaults();
}

void
ForwardProjectorByBinUsingProjMatrixByBin::initialise_keymap() {
...
bool
ForwardProjectorByBinUsingProjMatrixByBin::post_processing() {
...
ForwardProjectorByBinUsingProjMatrixByBin::ForwardProjectorByBinUsingProjMatrixByBin() { set_defaults(); }

ForwardProjectorByBinUsingProjMatrixByBin::ForwardProjectorByBinUsingProjMatrixByBin(
...
void
ForwardProjectorByBinUsingProjMatrixByBin::set_up(const shared_ptr<const ProjDataInfo>& proj_data_info_ptr,
...
void
ForwardProjectorByBinUsingProjMatrixByBin::actual_forward_project(RelatedViewgrams<float>& viewgrams,
					    ...
					    !proj_matrix_ptr->does_cache_store_only_basic_bins()*/)
  {
    ...
    for (int tang_pos = min_tangential_pos_num; tang_pos <= max_tangential_pos_num; ++tang_pos)
      for (int ax_pos = min_axial_pos_num; ax_pos <= max_axial_pos_num; ++ax_pos) {
        ...
        symmetries->get_related_bins_factorised(r_ax_poss, basic_bin, min_axial_pos_num, max_axial_pos_num,
        ...
        for (
            ...
            r_ax_poss_iter != r_ax_poss.end(); ++r_ax_poss_iter) {
