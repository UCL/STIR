/*
    ...
    Copyright (C) 2013-2014, 2017-2022, 2024 University College London
...
static void
get_viewgrams(shared_ptr<RelatedViewgrams<float>>& y,
...
#  ifndef NDEBUG
  ...
  if (distributed::test && distributed::first_iteration == true && next_receiver == 1)
    distributed::test_related_viewgrams_master(
        y->get_proj_data_info_sptr()->create_shared_clone(), symmetries_sptr, y.get(), next_receiver);
#  endif
...

{
  ...
  */
  ...
  if (caching_info_ptr != NULL)
    {
      distributable_computation_cache_enabled(forward_projector_ptr,
                                              back_projector_ptr,
                                              symmetries_ptr,
                                              output_image_ptr,
                                              input_image_ptr,
