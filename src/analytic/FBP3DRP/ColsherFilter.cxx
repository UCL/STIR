...
ColsherFilter::ColsherFilter(float theta_max_v, float alpha_colsher_axial_v, float fc_colsher_axial_v,
                             float alpha_colsher_planar_v, float fc_colsher_planar_v, const int stretch_factor_axial,
                             const int stretch_factor_planar)
    : theta_max(theta_max_v), alpha_axial(alpha_colsher_axial_v), fc_axial(fc_colsher_axial_v),
      alpha_planar(alpha_colsher_planar_v), fc_planar(fc_colsher_planar_v), stretch_factor_axial(stretch_factor_axial),
...
ColsherFilter::ColsherFilter(int height_v, int width_v, float gamma_v, float theta_max_v, float d_a_v, float d_b_v,
                             float alpha_colsher_axial_v, float fc_colsher_axial_v, float alpha_colsher_planar_v,
                             float fc_colsher_planar_v)
    : Filter2D<float>(height_v, width_v), gamma(gamma_v), theta_max(theta_max_v), d_a(d_a_v), d_b(d_b_v),
      alpha_axial(alpha_colsher_axial_v), fc_axial(fc_colsher_axial_v), alpha_planar(alpha_colsher_planar_v),
