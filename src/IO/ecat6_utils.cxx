...
int cti_read_scan_subheader (FILE *fptr, const ECAT6_Main_header *, int blknum, Scan_subheader *h)
{
    int status ;
...
int cti_read_attn_subheader(FILE* fptr, const ECAT6_Main_header *, int blknum, Attn_subheader *header)
{
  short int bufr[256];
  int  err;
...
int cti_read_norm_subheader(FILE* fptr, const ECAT6_Main_header *, int blknum, Norm_subheader *header)
{
  short int bufr[256];
  int  err;
...
int cti_read_image_subheader (FILE *fptr, const ECAT6_Main_header *, int blknum, Image_subheader *ihead)
{
    int status;
    char  *bb;
...
int cti_enter (FILE *fptr, const ECAT6_Main_header*, long matnum, int nblks)
{
...
int cti_lookup (FILE *fptr, const ECAT6_Main_header*, long matnum, MatDir *entry)
{
    int blk, status;
...
#ifdef STIR_ORIGINAL_ECAT6
int cti_write_image_subheader (FILE *fptr, const ECAT6_Main_header *, int blknum, const Image_subheader *header)
{
    int status;
    char *bbufr;
...
int cti_write_scan_subheader (FILE *fptr, const ECAT6_Main_header *, int blknum, const Scan_subheader *header)
{
    int status;
    short bufr[MatBLKSIZE / sizeof (short)];
