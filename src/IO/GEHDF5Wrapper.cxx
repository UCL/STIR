...
Succeeded
GEHDF5Wrapper::read_sinogram(Array<3, unsigned char>& output, const std::array<hsize_t, 3>& offset,
...
Succeeded
GEHDF5Wrapper::read_geometric_factors(Array<1, unsigned int>& output, const std::array<hsize_t, 2>& offset,
                                      const std::array<hsize_t, 2>& count, const std::array<hsize_t, 2>& stride)
...
Succeeded
GEHDF5Wrapper::read_efficiency_factors(Array<1, float>& output, const std::array<hsize_t, 2>& offset,
