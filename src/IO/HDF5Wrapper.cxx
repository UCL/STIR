...
Succeeded HDF5Wrapper::initialise_scanner_from_HDF5()
{
   // H5::DataSet str_num_rings = file.openDataSet("/HeaderData/SystemGeometry/");
    ...
    H5::DataSet type = file.openDataSet("/HeaderData/ExamData/scannerDesc");
    type.read(type,vlst);
    ...
    int num_transaxial_blocks_per_bucket(H5T_NATIVE_INT);
    str_radial_blocks_per_module.read(num_transaxial_blocks_per_bucket, H5::PredType::NATIVE_B32);

    int num_axial_blocks_per_bucket(H5T_NATIVE_INT);
    str_axial_blocks_per_module.read(num_axial_blocks_per_bucket, H5::PredType::NATIVE_B32);
    ...
    str_intrinsic_tilt.read(intrinsic_tilt, H5::PredType::NATIVE_FLOAT);
     ...
     int max_num_non_arccorrected_bins(H5T_NATIVE_INT);
    str_max_number_of_non_arc_corrected_bins.read(max_num_non_arccorrected_bins, H5::PredType::NATIVE_B32);

    int num_transaxial_crystals_per_block(H5T_NATIVE_INT);
    str_radial_crystals_per_block.read(num_transaxial_crystals_per_block, H5::PredType::NATIVE_B32);

    int num_axial_crystals_per_block(H5T_NATIVE_INT);
    str_axial_crystals_per_block.read(num_axial_crystals_per_block, H5::PredType::NATIVE_B32);
