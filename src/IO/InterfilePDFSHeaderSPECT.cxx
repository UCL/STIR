...
InterfilePDFSHeaderSPECT::InterfilePDFSHeaderSPECT() : InterfileHeader() {
  num_segments = 1;
  num_views = -1;
...
InterfilePDFSHeaderSPECT::post_processing() {
  ...
  ProjDataInfoCylindricalArcCorr* my_data_info_ptr =
      new ProjDataInfoCylindricalArcCorr(scanner_ptr_from_file, float(bin_size_in_cm * 10.), sorted_num_axial_poss_per_segment,
