...
const char* const ECAT7ParametricDensityOutputFileFormat<DiscretisedDensityT>::registered_name = "ECAT7";

template <class DiscretisedDensityT>
ECAT7ParametricDensityOutputFileFormat<DiscretisedDensityT>::ECAT7ParametricDensityOutputFileFormat(const NumericType& type,
...
template <class DiscretisedDensityT>
void
ECAT7ParametricDensityOutputFileFormat<DiscretisedDensityT>::initialise_keymap() {
...
template <class DiscretisedDensityT>
void
ECAT7ParametricDensityOutputFileFormat<DiscretisedDensityT>::set_defaults() {
...
template <class DiscretisedDensityT>
bool
ECAT7ParametricDensityOutputFileFormat<DiscretisedDensityT>::post_processing() {
...
template <class DiscretisedDensityT>
NumericType
ECAT7ParametricDensityOutputFileFormat<DiscretisedDensityT>::set_type_of_numbers(const NumericType& new_type, const bool warn) {
...
template <class DiscretisedDensityT>
ByteOrder
ECAT7ParametricDensityOutputFileFormat<DiscretisedDensityT>::set_byte_order(const ByteOrder& new_byte_order, const bool warn) {
...
template <class DiscretisedDensityT>
Succeeded
ECAT7ParametricDensityOutputFileFormat<DiscretisedDensityT>::actual_write_to_file(
    std::string& filename, const ParametricDiscretisedDensity<DiscretisedDensityT>& parametric_density) const {
  shared_ptr<Scanner> scanner_ptr(Scanner::get_scanner_from_name(this->default_scanner_name));

  add_extension(filename, ".img");

  typedef typename ParametricDiscretisedDensity<DiscretisedDensityT>::SingleDiscretisedDensityType SingleDensityType;
