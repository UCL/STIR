...
InputStreamFromROOTFile::check_brentry_randoms_scatter_energy_conditions(Long64_t brentry)
{
  ...
  if (this->exclude_scattered || this->exclude_unscattered || this->maximum_order_of_scatter >= 0) {
    ...
    if (this->exclude_unscattered && (this->comptonphantom1 == 0 && this->comptonphantom2 == 0))
      return false;
    if ((this->maximum_order_of_scatter >= 0) && (this->comptonphantom1 + this->comptonphantom2 > this->maximum_order_of_scatter))
      return false;
  }
  ...
  if (this->check_energy_window_information){
    ...
    if (this->get_energy1_in_keV() < this->low_energy_window_1 ||
        this->get_energy1_in_keV() > this->up_energy_window_1 ||
        this->get_energy2_in_keV() < this->low_energy_window_2 ||
        this->get_energy2_in_keV() > this->up_energy_window_2)
    {
      return false;
    }
  }
