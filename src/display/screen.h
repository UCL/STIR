...
#  define SC_RECT(x, y)                                                                                                          \
    (SC__filled ? XFillRectangle(SCX_display, SCX_window, SCX_gc, (int)Min(x, SC__curPointX), (int)Min(y, SC__curPointY),        \
                                 (unsigned int)abs(x - SC__curPointX), (unsigned int)abs(y - SC__curPointY))                     \
                : XDrawRectangle(SCX_display, SCX_window, SCX_gc, (int)Min(x, SC__curPointX), (int)Min(y, SC__curPointY),        \
                                 (unsigned int)abs(x - SC__curPointX), (unsigned int)abs(y - SC__curPointY)))
#  define SC_RECTR(x, y)                                                                                                         \
    (SC__filled ? XFillRectangle(SCX_display, SCX_window, SCX_gc, (x < 0 ? SC__curPointX + x : SC__curPointX),                   \
                                 (y < 0 ? SC__curPointY + y : SC__curPointY), abs(x), abs(y))                                    \
                : XDrawRectangle(SCX_display, SCX_window, SCX_gc, (x < 0 ? SC__curPointX + x : SC__curPointX),                   \
                                 (y < 0 ? SC__curPointY + y : SC__curPointY), abs(x), abs(y)))
...
#  define SC_CLEAR_BLOCK(color, x_b, x_e, y_b, y_e)                                                                              \
    ...
    XFillRectangle(SCX_display, SCX_window, SCX_gc, Min((x_b), (x_e)), Min((y_b), (y_e)), abs((x_b) - (x_e)),                    \
                   abs((y_b) - (y_e)));                                                                                          \
...
extern int center_sc_images(int* Pscale, int min_x, int max_x, int min_y, int max_y, int SIZE_X, int SIZE_Y,
