...
#include "interfile.h"
// KT 21/10/98 include for allowing input from file
#include "utilities.h"
...
// KT 14/10/98 new, isolated from main()
void 
...
main()
{
  ...
  switch (ask_num("Start image is cuboid (1) or cylindroid (2) or on file (3)",1,3,2))
  {
  case 1:
...
void fill_cylindroid(PETImageOfVolume& image, const PETScannerInfo& scanner)
{
  ...
  const int num_samples = 
    ask_num("With how many points (in x,y direction) do I sample each voxel ?",1,100,5);
