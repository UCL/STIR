...
public:
  ...
  TestFBP2D(const std::string& proj_data_filename = "", const std::string& density_filename = "")
      : base_type(proj_data_filename, density_filename)
  {}
  ~TestFBP2D() override {}

  std::unique_ptr<ProjDataInfo> construct_default_proj_data_info_uptr() const override;
...
TestFBP2D::construct_default_proj_data_info_uptr() const
{
