...
do_segments(DiscretisedDensity<3, float>& image,
            ...
            const int start_timing_num,
            const int end_timing_num,
  ...
  do
    {
      int min_timing_num = ask_num("Minimum timing position index to backproject",
                                   ...
                                   proj_data_info_sptr->get_max_tof_pos_num(),
                                   proj_data_info_sptr->get_min_tof_pos_num());
      ...
      int min_segment_num = ask_num("Minimum segment number to backproject",
                                    ...
                                    0);
      int max_segment_num = ask_num(
          "Maximum segment number to backproject", min_segment_num, proj_data_info_sptr->get_max_segment_num(), min_segment_num);
      ...
      const int start_tang_pos_num = ask_num("Start tang_pos",
                                             proj_data_info_sptr->get_min_tangential_pos_num(),
                                             proj_data_info_sptr->get_max_tangential_pos_num(),
                                             proj_data_info_sptr->get_min_tangential_pos_num());
      const int end_tang_pos_num = ask_num("End  tang_pos",
                                           start_tang_pos_num,
                                           proj_data_info_sptr->get_max_tangential_pos_num(),
                                           proj_data_info_sptr->get_max_tangential_pos_num());
