...
void
HUToMuImageProcessor<TargetT>::
set_slope_filename(const std::string& arg)
{
  this->filename = arg;
}
...
void
HUToMuImageProcessor<TargetT>::
set_manufacturer_name(const std::string& arg)
{
...
void
HUToMuImageProcessor<TargetT>::
set_kilovoltage_peak(const float arg)
{
...
void
HUToMuImageProcessor<TargetT>::
set_target_photon_energy(const float arg)
{
...
void
HUToMuImageProcessor<TargetT>::
apply_scaling_to_HU(TargetT& output_image,
...
void
HUToMuImageProcessor<TargetT>::
virtual_apply(TargetT& out_density, const TargetT& in_density) const
{
...
void
HUToMuImageProcessor<TargetT>::
 virtual_apply(TargetT& density) const 
{
