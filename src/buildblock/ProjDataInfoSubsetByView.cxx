...
Bin
ProjDataInfoSubsetByView::get_bin(const LOR<float>& lor, const std::pair<int,int> &energy_window_pair) const
{
  return get_bin_from_original(this->org_proj_data_info_sptr->get_bin(lor, energy_window_pair));
}
