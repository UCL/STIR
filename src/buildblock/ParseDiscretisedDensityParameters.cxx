...
void
ParseDiscretisedDensityParameters::set_defaults()
{
...
void
ParseDiscretisedDensityParameters::add_to_keymap(KeyParser& parser)
{
...
void
ParseDiscretisedDensityParameters::check_values() const
{
  if (zoom_xy <= 0)
    {
...
int
ParseDiscretisedDensityParameters::get_output_image_size_xy() const
{
  return this->output_image_size_xy;
}

void
ParseDiscretisedDensityParameters::set_output_image_size_xy(int v)
{
  this->output_image_size_xy = v;
}

int
ParseDiscretisedDensityParameters::get_output_image_size_z() const
{
  return this->output_image_size_z;
}

void
ParseDiscretisedDensityParameters::set_output_image_size_z(int v)
{
  this->output_image_size_z = v;
}

float
ParseDiscretisedDensityParameters::get_zoom_xy() const
{
  return this->zoom_xy;
}

void
ParseDiscretisedDensityParameters::set_zoom_xy(float v)
{
  this->zoom_xy = v;
}

float
ParseDiscretisedDensityParameters::get_zoom_z() const
{
  return this->zoom_z;
}

void
ParseDiscretisedDensityParameters::set_zoom_z(float v)
{
  this->zoom_z = v;
}

const CartesianCoordinate3D<float>&
ParseDiscretisedDensityParameters::get_offset() const
{
  return this->offset;
}

void
ParseDiscretisedDensityParameters::set_offset(const CartesianCoordinate3D<float>& v)
{
  this->offset = v;
}
