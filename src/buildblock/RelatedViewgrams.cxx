...
RelatedViewgrams<elemT>::has_same_characteristics(self_type const& other, string& explanation) const
{
  ...
  if (*this->get_symmetries_ptr() != *other.get_symmetries_ptr())
    {
      explanation = str(format("Differing symmetries"));
      return false;
    }
  if (this->get_basic_view_num() != other.get_basic_view_num())
    {
      explanation
          = str(format("Differing basic view number: %1% vs %2%") % this->get_basic_view_num() % other.get_basic_view_num());
      return false;
    }
  if (this->get_basic_segment_num() != other.get_basic_segment_num())
    {
      explanation = str(format("Differing basic segment number: %1% vs %2%") % this->get_basic_segment_num()
