...
// #endif
// #ifdef STIR_TOF
//   for (int i_tof_in = projdata_in_sptr->get_min_tof_pos_num(); i_tof_in <= projdata_in_sptr->get_max_tof_pos_num(); ++i_tof_in)
//     {
// #endif
...
//           Array<3, float> extended3 = extend_segment_in_views(projdata_in_sptr->get_segment_by_sinogram(i_seg_in /*, i_tof_in*/),
//                                                               2,
//                                                               2,
...
//   for (int i_tof_in = in_up_projdata_in->get_min_tof_pos_num(); i_tof_in <= in_up_projdata_in->get_max_tof_pos_num(); ++i_tof_in)
//     {
...
//               for (int i_view = out_projdata_info_sptr->get_min_view_num(); i_view <= out_projdata_info_sptr->get_max_view_num();
//                    ++i_view)
//                 {
