...
SeparableGaussianArrayFilter<num_dimensions, elemT>::SeparableGaussianArrayFilter() : fwhms(0), max_kernel_sizes(0) {
...
SeparableGaussianArrayFilter<num_dimensions, elemT>::SeparableGaussianArrayFilter(const float fwhms_v,
                                                                                  const float max_kernel_sizes_v, bool normalise)
...
SeparableGaussianArrayFilter<num_dimensions, elemT>::SeparableGaussianArrayFilter(
    const BasicCoordinate<num_dimensions, float>& fwhms_v, const BasicCoordinate<num_dimensions, int>& max_kernel_sizes_v,
    bool normalise)
...
SeparableGaussianArrayFilter<num_dimensions, elemT>::calculate_coefficients(VectorWithOffset<elemT>& filter_coefficients,
                                                                            const int max_kernel_sizes, const float fwhms,
                                                                            bool normalise)
