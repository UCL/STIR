...
template <typename T>
void
overlap_interpolate(VectorWithOffset<T>& out_data, const VectorWithOffset<T>& in_data, const float zoom, const float offset,
...
template void overlap_interpolate<>(VectorWithOffset<float>& out_data, const VectorWithOffset<float>& in_data, const float zoom,
                                    const float offset, const bool assign_rest_with_zeroes);

template void overlap_interpolate<>(VectorWithOffset<double>& out_data, const VectorWithOffset<double>& in_data, const float zoom,
                                    const float offset, const bool assign_rest_with_zeroes);
END_NAMESPACE_STIR
...
template void overlap_interpolate<>(VectorWithOffset<Tensor1D<float>>& out_data, const VectorWithOffset<Tensor1D<float>>& in_data,
                                    const float zoom, const float offset, const bool assign_rest_with_zeroes);

template void overlap_interpolate<>(VectorWithOffset<Tensor2D<float>>& out_data, const VectorWithOffset<Tensor2D<float>>& in_data,
                                    const float zoom, const float offset, const bool assign_rest_with_zeroes);
...
template void overlap_interpolate<>(VectorWithOffset<Array<1, float>>& out_data, const VectorWithOffset<Array<1, float>>& in_data,
                                    const float zoom, const float offset, const bool assign_rest_with_zeroes);

template void overlap_interpolate<>(VectorWithOffset<Array<2, float>>& out_data, const VectorWithOffset<Array<2, float>>& in_data,
                                    const float zoom, const float offset, const bool assign_rest_with_zeroes);
#endif
