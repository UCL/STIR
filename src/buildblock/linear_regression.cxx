...
/*
  ...
  \brief Implementation for stir::linear_regression() function
...
void
linear_regression_compute_fit_from_S(Value& constant, Value& scale, Value& chi_square, Value& variance_of_constant,
...
// instantiations
template void linear_regression_compute_fit_from_S<>(float& constant, float& scale, float& chi_square,
                                                     float& variance_of_constant, float& variance_of_scale,
                                                     float& covariance_of_constant_with_scale, const double S, const double Sx,
                                                     const double Sy, const double Syy, const double Stt, const double Sty,
                                                     const std::size_t data_size, const bool use_estimated_variance);

template void linear_regression_compute_fit_from_S<>(double& constant, double& scale, double& chi_square,
                                                     double& variance_of_constant, double& variance_of_scale,
                                                     double& covariance_of_constant_with_scale, const double S, const double Sx,
                                                     const double Sy, const double Syy, const double Stt, const double Sty,
                                                     const std::size_t data_size, const bool use_estimated_variance);
