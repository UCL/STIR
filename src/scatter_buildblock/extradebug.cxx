#ifndef NDEBUGXXX
{
  ...
  }
  {
    ...
    info(boost::format("first/last z for detectors after shift: %1%/%2%") % first % last);
  }
}
#endif
...
#ifndef NDEBUG
{
  ...
  info(boost::format("Coordinates of centre of first and last voxel of scatter-point image after shifting to centre of scanner: "
                     "%1% / %2% centre %3%") %
