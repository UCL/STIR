...
SingleScatterSimulation::SingleScatterSimulation() : base_type() { this->set_defaults(); }

SingleScatterSimulation::SingleScatterSimulation(const std::string& parameter_filename) { this->initialise(parameter_filename); }
