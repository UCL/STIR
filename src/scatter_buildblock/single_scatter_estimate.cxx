...
double
SingleScatterSimulation::scatter_estimate(const Bin& bin) {
...
void
SingleScatterSimulation::actual_scatter_estimate(double& scatter_ratio_singles, const unsigned det_num_A,
  ...
  const double common_factor =
      1 / detection_efficiency_no_scatter(det_num_A, det_num_B) * scatter_volume / total_Compton_cross_section_511keV;
