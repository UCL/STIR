...
float
SinglesRatesForTimeFrames::get_singles(const int singles_bin_index, const unsigned int time_frame_num) const
{
  return (this->_singles[time_frame_num][singles_bin_index]);
}

void
SinglesRatesForTimeFrames::set_singles(const int singles_bin_index, const unsigned time_frame_num, const float new_singles)
{
  this->_singles[time_frame_num][singles_bin_index] = new_singles;
}

float
SinglesRatesForTimeFrames::get_singles(const int singles_bin_index, const double start_time, const double end_time) const
{
