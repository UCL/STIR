...
GenerateImage::initialise_keymap()
{
  ...
  add_key("imaging modality",
          KeyArgument::ASCII,
          (KeywordProcessor)&GenerateImage::set_imaging_modality,
...
GenerateImage::compute()
{
  ...
  for (std::vector<shared_ptr<Shape3D>>::const_iterator iter = shape_ptrs.begin(); iter != shape_ptrs.end(); ++iter, ++value_iter)
    {
