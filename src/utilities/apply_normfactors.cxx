  ...
  if (argc < 7 || argc > 10)
    {
      std::cerr << "Usage: " << argv[0]
                << " out_filename in_norm_filename_prefix measured_data multiply_or_divide iter_num eff_iter_num [do_eff [ "
                   "do_geo [ do_block]]]\n"
  ...
  for (int ax_pos_num = measured_data->get_min_axial_pos_num(segment_num);
       ...
       ++ax_pos_num)
    {
        ...
        }
      {
        ...
        set_det_pair_data(*out_proj_data_ptr, det_pair_data, segment_num, ax_pos_num);
      }
    }
