...
main(int argc, char** argv) {
  ...
  for (int frame = 1; frame <= num_frames; ++frame) {
    ...
    cout << setw(2) << frame << "  " << setw(8) << singles_from_ecat7.get_time_frame_definitions().get_start_time(frame)
         << " to  " << setw(8) << singles_from_ecat7.get_time_frame_definitions().get_end_time(frame) << "   ";
