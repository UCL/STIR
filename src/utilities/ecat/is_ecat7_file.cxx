...
main(int argc, char** argv) {
  ...
  switch (option) {
  case opt_none:
    value = stir::ecat::ecat7::is_ECAT7_file(filename);
    break;
  case opt_image:
    value = stir::ecat::ecat7::is_ECAT7_image_file(filename);
    break;
  case opt_emission:
    value = stir::ecat::ecat7::is_ECAT7_emission_file(filename);
    break;
  case opt_ACF:
    value = stir::ecat::ecat7::is_ECAT7_attenuation_file(filename);
    break;
  default:
    value = false;
  }
