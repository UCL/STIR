...
classic_SSRB(int argc, char** argv) {
  ...
  // do standard SSRB
  SSRB(output_filename, *in_projdata_ptr, num_segments_to_combine, num_views_to_combine, num_tangential_poss_to_trim, do_norm,
...
template_based_SSRB(int argc, char** argv) {
  ...
  ProjDataInterfile out_proj_data(in_projdata_ptr->get_exam_info_sptr(), template_projdata_ptr->get_proj_data_info_sptr(),
