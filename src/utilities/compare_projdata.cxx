...
int main(int argc, char *argv[])
{
  ...
  {
    const shared_ptr<ProjDataInfo> first_sptr(first_operand->get_proj_data_info_sptr()->clone());
    const shared_ptr<ProjDataInfo> second_sptr(second_operand->get_proj_data_info_sptr()->clone());
    if (argc==4)
      {
