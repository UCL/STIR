...
int main(int argc, char **argv)
{
      ...
      "Cylindrical")
  {
    const ProjDataInfoCylindrical * const in_projdata_info_cyl_ptr =
      dynamic_cast<ProjDataInfoCylindrical const * >(in_projdata_ptr->get_proj_data_info_sptr()->clone());
            ...
            "BlocksOnCylindrical")
  {
    const ProjDataInfoBlocksOnCylindrical * const in_projdata_info_blk_ptr =
      dynamic_cast<ProjDataInfoBlocksOnCylindrical const * >(in_projdata_ptr->get_proj_data_info_sptr()->clone());
            ...
            "Generic")
  {
    const ProjDataInfoGeneric * const in_projdata_info_gen_ptr =
      dynamic_cast<ProjDataInfoGeneric const * >(in_projdata_ptr->get_proj_data_info_sptr()->clone());
