...
# The variable FMT_DEPENDENCIES is necessary if your library uses stir/format.h
# (see STIR/CMakeLists.txt)
target_link_libraries($(dir) PUBLIC buildblock ${FMT_DEPENDENCIES})
