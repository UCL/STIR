...
as output by OpenGATE (when using CylindericalPET or ECAT systems).
You need to create a text file header for your ROOT file, see
\texttt{examples/samples/root\_header.hroot}.
