...
this type can be found in the ''Other info'' section of the STIR website.
...
Since STIR 2.0, all iterative algorithms use a \textit{generalised objective 
...
Currently, only Poisson-based objective functions are implemented in STIR. We
...
dynamic data, called \textbf{POSMAPOSL} and \textbf{POSSPS} respoectively. 
...
Since STIR 2.1, this utility also supports parametric or dynamic data using
