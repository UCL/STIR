...
\subsubsection{
Maximum Likelihood Estimation (with optional penalty) algorithms}

Two statistical reconstruction algorithms are currently supported:
\begin{description}
...
{ \subsubsubsubsection{Running OSSPS}
 ...
 Most of what has been described above for OSMAPOSL applies verbatim for OSSPS. The
 ...
 \item[relaxation parameter]
   $\alpha$ in the formula above
 \item[relaxation gamma]
   $\gamma$ in the formula above
