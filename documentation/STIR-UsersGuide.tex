...
which maybe used as a spatially variant penalty strength $\kappa$ (or \textit{kappa image}) within iterative
reconstruction algorithms, see \ref{sec:priors:Quadratic}.

This utility computes a Hessian of the objective function and multiplies it by the forward projection of ones in
data space before backprojection into image space. The square root of the image is saved to file. Along with a method
...
This implements a Relative Difference Prior RDP, proposed by J. Nuyts, et.al., 2002. The gradient of the prior is computed as follows:
  ...
  modification the penatly function used to prevent divide by zero's.
