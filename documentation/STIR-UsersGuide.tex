...
The filter can be optionally normalised to 1.

The rules which apply to the construction and application of the Gaussian filter follow the one of the Metz filter.
