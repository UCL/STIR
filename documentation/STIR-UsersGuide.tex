...
utility called \texttt{warp\_and\_accumulate\_gated\_images}.
...
Cartesian grid are implemented. Information is stored in millimeter. The origin
of the motion vectors system is located in the same place as the coordinate
system The coordinate axes for Cartesian grids are chosen as follows.


$m_x$: motion on the horizontal axis, pointing left when
looking from the bed into the gantry 

$m_y$: motion on the vertical axis, pointing upwards

$m_z$: motion on the scanner axis, pointing from the bed
towards the gantry

See figure below for an illustration of how the warping operator works in a 3D grid.
As it can be noticed, the motion vector arrow is located at the centre of the
voxel and the direction of the motion field points opposite than the standard
grid. This is also known as \textit{pull-interpolator} warping operation.

%TODO<img width=216 height=176 src="Software_Description_files/image005.png" align=left hspace=12>
...
\R2Lurl{http://dx.doi.org/10.1016/j.media.2011.02.009}{http://dx.doi.org/10.1016/j.media.2011.02.009} 
...
vol. 2, pp. 1339-1342, 
\R2Lurl{http://dx.doi.org/10.1109/NSSMIC.1996.591692}{http://dx.doi.org/10.1109/NSSMIC.1996.591692}
...
\R2Lurl{http://link.aip.org/link/doi/10.1118/1.2192581}{http://dx.doi.org/10.1118/1.2192581}
...
Tsoumpas and P. K. Marsden \textbf{(2012)}, A new algorithm for scaling of PET
scatter estimates using all coincidence events. \textit{Med Phys} vol. 39, 3586-3590, 
\R2Lurl{http://dx.doi.org/10.1118/1.4754586}{http://dx.doi.org/10.1118/1.4754586}.
...
\R2Lurl{http://dx.doi.org/10.1109/TMI.2008.917248}{http://dx.doi.org/10.1109/TMI.2008.917248}.
...
\R2Lurl{http://dx.doi.org/10.1088/0031-9155/58/6/1759}{http://dx.doi.org/10.1088/0031-9155/58/6/1759}.
