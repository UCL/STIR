...
\url{http://sourceforge.net/apps/mediawiki/stir}{STIR Wiki} for more
...
\url{"http://www.cmake.org"}{CMake}. This is the recommended way to build STIR as
...
{ \subsubsubsection{Parallel Level Sets}
This implements the  anatomical penalty function, Parallel Level Sets (PLS),  proposed by Matthias J. Ehrhardt et. al [Ehr16]. Note that
  PLS becomes smoothed TV when no anatomical information is available.  The prior function is the following:
