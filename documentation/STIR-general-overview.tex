...
be released in the near future. Implementations of 
OSCB [Mar99] and OSSPS [Ahn03] are partly finished. 
...
Please use 
another backprojector. See the User's Guide.
...
\begin{itemize}
\item 
Parsytec CC with either EPX or PVM 
\end{itemize}
...
\begin{itemize}
\item 
gcc 2.95.2 or higher (gcc 3.0.1 or higher highly recommended). 
(Do not use non-official gcc releases often distributed with 
Linux systems such as Red Hat's 2.96. It's buggy!)
\item 
on Windows, Visual C++ 6.0 Service Pack 3 or higher. VC 2003 works fine. We have 
...
\begin{itemize}
\item 
GE Advance, Discovery LS, Discovery ST 
\item 
PRT-1 
\item 
...
\begin{itemize}
\item 
An extension of the Interfile standard (see \R2Lurl{http://www.HammersmithImanet.com/~kris/ }{http://www.HammersmithImanet.com/~kris/}) 
\item 
GE Advance native sinogram format, but for reading only (with 
very limited support for the header). Discovery ST data not yet supported.
\item 
