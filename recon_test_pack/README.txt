...
sensitivity and OSEMMain work as expected. This works by checking
their output with output generated by the PARAPET team itself.
...
parapet.users@listbot.com, with all log files attached to the email.
