...
int main()
{
  ...
  shared_ptr<ProjMatrixByBin> projection_matrix(new  ProjMatrixByBinUsingRayTracing());
  BackProjectorByBinUsingProjMatrixByBin back_projector(projection_matrix); 
